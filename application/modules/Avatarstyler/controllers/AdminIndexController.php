...
//      ));
      ...
      if ($form->Filedata->getValue() !== null) {
          ...
          //$log->log("-----Image----------------:".json_decode($file),Zend_Log::DEBUG);
          if ($file && $photoStrIds) {
            ...
            $form->addNotice('some entry missing please check my.sql file');
          }
      }
...
//      Delete photo from Storage
      ...
      $log->log("-----Install log----------------: ",Zend_Log::DEBUG);
      $parent = $tableS->delete(array(
        'file_id = ?' => $id,
      ));
      if($parent)
      {
