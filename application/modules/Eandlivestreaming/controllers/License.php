...
$module_name = 'eandlivestreaming';

//product title and module title.
$module_title = 'Live Streaming in Android Mobile App';
...
if ($this->getRequest()->isPost()) {
  ...
  //license key
  $postdata['licenseKey'] = @base64_encode($_POST['eandlivestreaming_licensekey']);
  ...
  if ($server_output == "OK" && $error != 1) {
    ...
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('eandlivestreaming.pluginactivated')) {
      ...
      include_once APPLICATION_PATH . "/application/modules/Eandlivestreaming/controllers/defaultsettings.php";

      Engine_Api::_()->getApi('settings', 'core')->setSetting('elivestreaming.pluginactivated', 1);
      Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.pluginactivated', 1);
      Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.licensekey', $_POST['eandlivestreaming_licensekey']);
    }
    ...
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.sesdomainauth', $domain_name);
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.seslkeyauth', $licensekey);
    $error = 1;
  } else {
    ...
    $form->addError($error);
    $error = 0;
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.sesdomainauth', '');
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.seslkeyauth', '');
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eandlivestreaming.licensekey', $_POST['eandlivestreaming_licensekey']);
    return;
