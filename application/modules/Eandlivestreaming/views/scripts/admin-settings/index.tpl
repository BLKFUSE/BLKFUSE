...
?>
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenuItemName' => 'core_admin_main_plugins', 'childMenuItemName' => 'eandlivestreaming_admin_main_eandlivestreaming')); ?>
<h2 class="page_heading"><?php echo $this->translate("Live Streaming in Android Mobile App") ?></h2>
...
<?php if(!Engine_Api::_()->getApi('settings', 'core')->getSetting('eandlivestreaming.pluginactivated',0)) { ?>
