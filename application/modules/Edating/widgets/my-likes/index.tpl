...
<h3><?php echo $this->translate("My likes"); ?></h3>
<div class="edating_users_notification">
  <span class="tip">
    <?php echo $this->translate("You rated these profiles 'yes'. They received notifications and after they rate yes on your profile, we will put it on mutual likes!"); ?>
  </span>
</div>
            ...
            <article>
              ...
              <div class='edating_users_listing_content'>
                ...
                <div class="edating_users_date sesbasic_font_small">
                  <p><?php echo $this->translate("Your sent like: "); ?> <?php echo date("d M, Y",$item->time_stamp); ?></p>
                  <p><?php echo $this->translate("Status: Awaiting response "); ?></p>
                </div>
                <div class='edating_users_listing_btns'>
                  <div><a href="javascript:void(0)" class='sesbasic_link_btn buttonlink fa-times' onclick="reject(<?php echo $item->getIdentity();?>, 'reject')"><?php echo $this->translate('Cancel');?></a></div>
                </div>
              </div>
            </article>
          </div>
