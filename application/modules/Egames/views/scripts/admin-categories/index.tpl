...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <div class="sesbasic-form-cont">
      ...
      <p class="description"> Games categories can be managed here. To create new categories, use "Add New Category" form below. <br /><br />To create 2nd-level categories and 3rd-level categories, choose respective 1st-level and 2nd-level category from “Parent Category” dropdown below. Choose this carefully as you will not be able to edit Parent Category later.<br /><br />To reorder the categories, click on their names or row and drag them up or down.".</p>
      <div class="sesbasic-categories-add-form">
        ...
        <form id="addcategory" method="post" enctype="multipart/form-data">
          ...
          <div class="sesbasic-form-field" style="display:none">
            <div class="sesbasic-form-field-label">
            ...
            <div class="sesbasic-form-field-element">
              <select name="parent" id="parent" class="postform">
               ...
               <?php foreach ($this->categories as $category): ?>
                ...
                <?php 
                  $subcategory = Engine_Api::_()->getDbtable('categories', 'egames')->getModuleSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));          foreach ($subcategory as $sub_category):  
                ?>
          ...
          <table class='admin_table' style="width: 100%;">
            <thead>
              <tr>
                ...
                <th style="display:none;"><?php echo $this->translate("Icon") ?></th>
                <th><?php echo $this->translate("Name") ?></th>
                <th  style="display:none;"><?php echo $this->translate("Slug") ?></th>
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-id="<?php echo $category->category_id; ?>">
                ...
                <td style="display:none;"><?php if($category->cat_icon): ?>
                ...
                <td  style="display:none;"><?php  echo $category->slug ; ?></td>
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'egames', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$category->category_id)); ?>
              </tr>
              	<?php if($category->category_id == 0) : ?>
                    <?php continue; ?>
                    <?php endif; ?>
              ...
              <tr id="categoryid-<?php echo $sub_category->category_id; ?>" data-id="<?php echo $sub_category->category_id; ?>">
                ...
                <td style="display:none;"><?php if($sub_category->cat_icon): ?>
                ...
                <td style="display:none;"><?php  echo $sub_category->slug ; ?></td>
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'egames', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $sub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$sub_category->category_id)) ?> 		</td>
              </tr>
              <?php 
                		//SubSubcategory Work
                    $subsubcategory = Engine_Api::_()->getDbtable('categories', 'egames')->getModuleSubsubcategory(array('column_name' => "*", 'category_id' => $sub_category->category_id));
              ...
              <tr id="categoryid-<?php echo $subsub_category->category_id; ?>" data-id="<?php echo $subsub_category->category_id; ?>">
                ...
                <td style="display:none;"><?php if($subsub_category->cat_icon): ?>
                ...
                <td style="display:none;"><?php  echo $subsub_category->slug ; ?></td>
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'egames', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $subsub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsub_category->category_id)) ?>
              </tr>
              <?php endforeach; ?>
              <?php endforeach; ?>
              <?php endforeach; ?>
...
ajaxurl = en4.core.baseUrl+"admin/egames/categories/change-order";
