 ...
 * @version    $Id: Gateway.php 2020-06-13  00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Egifts_Model_Gateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin()
  {
    if( null === $this->_plugin ) {
      $class = $this->plugin;
			$class = str_replace('Payment','Egifts',$class);
