 ...
 * @version    $Id: support.tpl 2020-06-13 00:00:00 socialnetworking.solutions $
...
<div class="sesbasic_support_links">
  <a href="https://socialnetworking.solutions/social-engine/virtual-gifts-plugin/" target="_blank">
    <i class="fa fa-file-text-o"></i>
    <h4>Detailed Description</h4>
    <p>Read all the details about this plugin on its description page.</p>
  </a>
  <a href="https://socialnetworking.solutions/plugins/virtualgifts/screenshots.html" target="_blank">
    <i class="fa fa-picture-o"></i>
    <h4>Screenshots</h4>
    <p>View all the screenshots to know how this plugin look & work.</p>
  </a>
  <a href="https://help.socialnetworking.solutions/faqs/category/virtual-gifts-plugin" target="_blank">
  ...
  <a href="https://socialnetworking.solutions/tag/virtualgifts/" target="_blank">
    <i class="fa fa-repeat"></i>
    <h4>Blog Updates</h4>
    <p>Checkout our blogs posts about new releases, announcements & upgrades.</p>
  </a>
  <a href="https://www.socialengine.com/store/product/virtual-gifts-plugin" target="_blank">
...
<div class="sesbasic_support_contact_links">
    ...
    <li>
    	<i><img src="application/modules/Sesbasic/externals/images/support/sns-icon.png" alt="" /></i>
