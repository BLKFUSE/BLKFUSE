        ...
        <div class="egifts_listing_item">
          <article class="sesbasic_bg sesbasic_animation">
            ...
            <div class="egifts_listing_item_info">
              ...
              <?php endif; ?>
              <?php if(isset($this->sentToActive)): ?>
              <?php $receipent = Engine_Api::_()->getItem('user', $order->purchase_user_id); ?>
              <div class="egifts_listing_item_user_info">
                <div class="egifts_listing_item_user sesbasic_text_light"> to <?php echo $receipent; ?> </div>
              </div>
              <?php endif; ?>
            </div>
          </article>
...
<?php } ?>
<?php }else { ?>
<div class="sesbasic_tip clearfix"> <img src="application/modules/Egifts/externals/images/gift-icon.png" alt="" /> <span class="sesbasic_text_light"> <?php echo $this->translate('No gift Send yet.') ?> </span> </div>
<?php } ?>
