...
$module_name = 'eioslivestreaming';

//product title and module title.
$module_title = 'Live Streaming in iOS Mobile App';
...
if ($this->getRequest()->isPost()) {
  ...
  //license key
  $postdata['licenseKey'] = @base64_encode($_POST['eioslivestreaming_licensekey']);
  ...
  if ($server_output == "OK" && $error != 1) {
    ...
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('eioslivestreaming.pluginactivated')) {
      ...
      Engine_Api::_()->getApi('settings', 'core')->setSetting('eioslivestreaming.pluginactivated', 1);
      Engine_Api::_()->getApi('settings', 'core')->setSetting('eioslivestreaming.licensekey', $_POST['eioslivestreaming_licensekey']);
    }
    ...
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eioslivestreaming.sesdomainauth', $domain_name);
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eioslivestreaming.seslkeyauth', $licensekey);
    $error = 1;
  } else {
