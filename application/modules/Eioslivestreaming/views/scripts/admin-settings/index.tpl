 ...
 * @version    $Id: index.tpl 2020-06-01  00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
 
?>
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenuItemName' => 'core_admin_main_plugins', 'childMenuItemName' => 'eioslivestreaming_admin_main_eioslivestreaming')); ?>
<h2 class="page_heading"><?php echo $this->translate("Live Streaming in iOS Mobile App") ?></h2>
...
<?php if(!Engine_Api::_()->getApi('settings', 'core')->getSetting('eioslivestreaming.pluginactivated',0)) { ?>
