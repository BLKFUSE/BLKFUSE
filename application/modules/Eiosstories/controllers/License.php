...
$module_name = 'eiosstories';

//product title and module title.
$module_title = 'Stories Feature in iOS Mobile App';
...
if ($this->getRequest()->isPost()) {
  ...
  //license key
  $postdata['licenseKey'] = @base64_encode($_POST['eiosstories_licensekey']);
  ...
  if ($server_output == "OK" && $error != 1) {
    ...
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('eiosstories.pluginactivated')) {
      ...
      include_once APPLICATION_PATH . "/application/modules/Eiosstories/controllers/defaultsettings.php";

      Engine_Api::_()->getApi('settings', 'core')->setSetting('eiosstories.pluginactivated', 1);
      Engine_Api::_()->getApi('settings', 'core')->setSetting('eiosstories.licensekey', $_POST['eiosstories_licensekey']);
    }
    ...
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eiosstories.sesdomainauth', $domain_name);
    Engine_Api::_()->getApi('settings', 'core')->setSetting('eiosstories.seslkeyauth', $licensekey);
    $error = 1;
  } else {
