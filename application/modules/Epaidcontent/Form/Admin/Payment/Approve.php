 ...
 */
class Epaidcontent_Form_Admin_Payment_Approve extends Engine_Form {
  ...
  public function init() {
    ...
    $givenSymbol = Engine_Api::_()->epaidcontent()->getCurrentCurrency();
    $gateways = Engine_Api::_()->getDbtable('usergateways', 'epaidcontent')->getUserGateway(array("enabled"=>true,'user_id'=>$this->getUserId(),'fetchAll'=>true));
