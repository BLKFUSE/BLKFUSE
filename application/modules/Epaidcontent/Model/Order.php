 ...
 * @version    $Id: Order.php 2022-08-16 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Epaidcontent_Model_Order extends Core_Model_Item_Abstract {
 ...
 public function getProduct() {
		if (null === $this->_product) {
			...
			$this->_product = $productTable->fetchRow($productTable->select()
											->where('extension_type = ?', 'epaidcontent_order')
	...
	public function getProductParams() {
			...
			$commissionType = Engine_Api::_()->authorization()->getPermission($viewer,'page','page_admcosn');
			$commissionTypeValue = Engine_Api::_()->authorization()->getPermission($viewer,'page','page_commival');
			...
			return array(
					'title' => 'order',
					'description' => 'epaidcontent_order',
					'price' => @round(($this->total_amount), 2),
					'extension_id' => $this->getIdentity(),
					'extension_type' => 'epaidcontent_order',
			);
    }
