...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
        ...
        <table class='admin_table'>
          <thead>
            <tr>
              ...
              <th><?php echo $this->translate("Package Title") ?></th>          
              <th><?php echo $this->translate("Subscriber Owner Name") ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="<?php echo $package->getHref(); ?>" target="_blank"><?php echo $item->title; ?></a></td>
              ...
              <td class="admin_table_centered"><?php echo Engine_Api::_()->epaidcontent()->getCurrencyPrice(round($item->total_amount,2),$defaultCurrency); ?></td>
              <td class="admin_table_centered">
                <?php echo date('Y-m-d',strtotime($item->creation_date)); ?>
              </td>
              <td>
                <?php echo $this->htmlLink($this->url(array('package_id' => $package->package_id,'action'=>'view','order_id'=>$item->order_id), 'epaidcontent_order', true).'?order=view', $this->translate("View Order"), array('title' => $this->translate("View Order"), 'class' => 'smoothbox')); ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
    ...
    <?php else:?>
      <div class="tip">
        <span>
          <?php echo $this->translate('No one has purchased paid content package on your website yet.') ?>
        </span>
      </div>
    <?php endif; ?>
    </div>
