...
<div class="epaidcontent_dashboard_content sesbm sesbasic_clearfix">
  ...
  <div class="epaidcontent_dashboard_search epaidcontent_sale_report_form">
      ...
      <table class="epaidcontent_manage_table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td data-label="<?php echo $this->translate("Date of Purchase") ?>" class='epaidcontent_manage_table_bold'><?php echo Engine_Api::_()->epaidcontent()->dateFormat($item->creation_date); ?></td> 
            <td class="centerT" data-label="<?php echo $this->translate("Quatity") ?>"><?php echo $item->total_orders; ?></td>
            <td  data-label="<?php echo $this->translate("Total Amount") ?>" class='epaidcontent_manage_table_price'><?php echo Engine_Api::_()->epaidcontent()->getCurrencyPrice($item->totalAmountSale,$defaultCurrency); ?></td>
          </tr>
          <?php $counter++;
                endforeach; ?>
        </tbody>
...
scriptJquery(document).on('click','.epaidcontent_report_download',function(){
	...
	scriptJquery('#epaidcontent_search_form_sale_report').trigger('submit');
