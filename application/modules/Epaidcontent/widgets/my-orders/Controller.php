...
class Epaidcontent_Widget_MyOrdersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_search_ajax) {
      $this->view->searchForm = $searchForm = new Epaidcontent_Form_Searchmyorder();
    }
