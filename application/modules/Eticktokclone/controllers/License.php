...
if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('eticktokclone.pluginactivated')) {
	...
	$db->query('INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES ("eticktokclone_main_tiktokclone", "eticktokclone", "TikTak Videos", "", \'{"route":"eticktokclone_default","icon":"far fa-play-circle", "action":"explore"}\', "core_main", "", 999);');
