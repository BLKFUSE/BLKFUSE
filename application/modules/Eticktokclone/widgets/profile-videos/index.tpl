 ...
 */
$randonNumber = "eticktokclone_video_cnt_";
?>
...
<div class="eticktokclone_profile_videos">
  <div class="eticktokclone_profile_videos_listing eticktokclone_profile_videos_listing_profile">
<?php } ?>
<?php
    ...
    <div class="eticktokclone_profile_videos_item">
      <article>
        <a href="<?php echo $item->getHref(); ?>" class="openVideoInLightbox" data-image="<?php echo $item->getPhotoUrl(); ?>">
          ...
          <div class="_cont">
            <h4 class="_title"><?php echo $item->getTitle(); ?></h4>
...
<script>
  scriptJquery( window ).load(function() {
		 scriptJquery(window).scroll( function() {
			  var heightOfContentDiv_<?php echo $randonNumber; ?> = scriptJquery('.eticktokclone_profile_videos_listing_profile').offset().top;
  ...
  function viewMore_<?php echo $randonNumber; ?> (){
    ...
    requestViewMore_<?php echo $randonNumber; ?> = scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        ...
        scriptJquery('.eticktokclone_profile_videos_listing_profile').append(responseHTML);
