...
class Eusertip_Form_Searchmyorder extends Engine_Form {
...
//     ));
    ...
    foreach($gateways as $gt){
      ...
      'type' => 'submit',
		...
		$this->addElement('Dummy','loading-img-eusertip', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="eusertip-search-order-img" alt="Loading" />',
   ));
  }
