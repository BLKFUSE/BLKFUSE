 ...
 */
class Eusertip_Model_DbTable_Userpayrequests extends Engine_Db_Table {

  protected $_name = 'eusertip_userpayrequests';
  protected $_rowClass = "Eusertip_Model_Userpayrequest";
