 ...
 * @version    $Id: Tip.php 2022-08-16 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Eusertip_Model_Tip extends Core_Model_Item_Abstract
{
    ...
    public function getProductParams()
    {
        ...
        'extension_id' => $this->tip_id,
        );
    }

    public function getTipDescription()
    {
    ...
    public function getExpirationDate($rel = null)
    {
        ...
        // If it's a one-time payment or a free tip with no duration, there
        // is no expiration
        if( ($this->isOneTime() || $this->isFree()) && !$this->hasDuration() ) {
        return false;
        }

        // If this is a free or one-time tip, the expiration is based on the
