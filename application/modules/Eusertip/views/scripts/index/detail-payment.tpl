...
<div class="eusertip_view_detail_popup">
  ...
  <table class="payment_requests_view_table">
    ...
    <tr>
      ...
      <td><?php echo Engine_Api::_()->eusertip()->getCurrencyPrice($this->item->requested_amount,$defaultCurrency) ; ?></td>
    </tr>
    <tr>
      <td class="bold"><?php echo $this->translate('Payment Request Date') ?>:</td>
      <td> <?php echo Engine_Api::_()->eusertip()->dateFormat($this->item->creation_date	); ?></td>
    </tr>
   <tr>
