 ...
 */
class Eusertip_Widget_ManageOrdersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_search_ajax) {
      $this->view->searchForm = $searchForm = new Eusertip_Form_Searchorder();
    }
    ...
    $this->view->orders = $orders = Engine_Api::_()->getDbtable('orders', 'eusertip')->manageOrders($value);
