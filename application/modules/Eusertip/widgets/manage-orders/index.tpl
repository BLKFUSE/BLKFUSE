...
<div class="sesbasic_dashboard_content_header sesbasic_clearfix">
  ...
  <br />
  <p><?php echo $this->translate('Below, you can manage the orders for your tips. You can use this page to monitor these orders. Entering criteria into the filter fields will help you find specific order.'); ?></p>
  <br />
</div>
    ...
    <table class="eusertip_manage_table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-label=" <?php echo $this->translate("Buyer") ?> " class='eusertip_manage_table_bold'>
...
function paggingNumbermanage_order(pageNum){
	 ...
	 var searchFormData = scriptJquery('#eusertip_search_ticket_search').serialize();
...
scriptJquery(document).on('click','.eusertip_search_ticket_search',function(e){
	e.prpageDefault();
	sendParamInSearch = scriptJquery(this).attr('data-rel');
	scriptJquery('#eusertip_search_ticket_search').trigger('click');
});
