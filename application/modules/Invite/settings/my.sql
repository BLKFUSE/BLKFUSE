...
('user_settings_invites', 'invite', 'Manage Invites / Referrals', 'Invite_Plugin_Menus', '{"route":"default", "module":"invite", "controller":"index", "action":"index", "icon":"fas fa-envelope-open"}', 'user_settings', '', 10);
