          ...
          <script type="text/javascript">
            scriptJquery(document).on('click','.copy_referral_code',function (e) {
              if(scriptJquery('#myreferralcode').val().length) {
                ...
                showSuccessTooltip(10,10,'<i class="fas fa-check-circle"></i><span>'+('<?php echo $this->translate("Referral code copied successfully."); ?>')+'</span>', 'referral_copied');
              }
            });
            ...
            <table>
              ...
              <tbody>
                <?php foreach( $this->paginator as $item): ?>
                  ...
                  <tr>
                    <td data-label="<?php echo $this->translate("Recipient Email") ?>"><a href='mailto:<?php echo $item->recipient ?>'><?php echo $item->recipient ?></a></td>
...
<script type="text/javascript">
  ...
  scriptJquery(document).on('click','.invite_code',function (e) {
    scriptJquery("<textarea/>").appendTo("body").val(scriptJquery(this).attr('data-invite-url')).select().each(function () {
      ...
      showSuccessTooltip(10,10,'<i class="fas fa-check-circle"></i><span>'+('<?php echo $this->translate("Referral link copied successfully."); ?>')+'</span>', 'referral_copied');
  });
