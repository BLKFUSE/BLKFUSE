...
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES ("core_admin_main_payment_templates", "payment", "Manage Templates", "", '{"route":"admin_default","module":"payment","controller":"templates"}', "core_admin_main_membership", "", 4);
