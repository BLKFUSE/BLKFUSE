              ...
              <td data-label="<?php echo $this->translate('Enabled') ?>" class="admin_table_centered">
                <?php if($currency->code != Engine_Api::_()->payment()->defaultCurrency()) { ?>
                  <?php if($currency->enabled): ?>
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'payment', 'controller' => 'settings', 'action' => 'enable', 'id' => $currency->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Core/externals/images/admin/check.png', '', array('title'=> $this->translate('Disable')))) ?>
                  <?php else: ?>
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'payment', 'controller' => 'settings', 'action' => 'enable', 'id' => $currency->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Core/externals/images/admin/uncheck.png', '', array('title'=> $this->translate('Enable')))) ?>
                  <?php endif; ?>
                <?php } else { ?>
                  <?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Core/externals/images/admin/check.png', '', array('title'=> $this->translate('Enable'))); ?>
                <?php } ?>
              </td>
