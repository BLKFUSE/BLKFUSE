...
var pokeinfo = function(poke_id, poke_receiver_id)
{
  ...
  var globalContentElement = $('se-content') ? 'se-content' : 'global_content';
	var parentnode = $(globalContentElement).getElement('.layout_poke_list_pokeusers').parentNode;
	var childnode =  $(globalContentElement).getElement('.layout_poke_list_pokeusers');
