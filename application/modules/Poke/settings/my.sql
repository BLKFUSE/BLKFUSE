...
CREATE TABLE `engine4_poke_settings` (`setting_id` INT( 11 ) NOT NULL AUTO_INCREMENT ,`user_id` INT( 11 ) NOT NULL ,`connection` INT( 11 ) NOT NULL ,PRIMARY KEY ( `setting_id` )) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_unicode_ci ;
...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('poke', 'Pokes', 'Pokes', '5.0.0', 1, 'extra');

-- -----------------------------------------------------------------------


INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
('poke_home_connection', 'poke', 'Poke Settings', 'Poke_Plugin_Menus', '{"route":"default"}', 'user_home', '', '999');
