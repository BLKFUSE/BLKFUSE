  	  ...
  	  <?php $div_id++; ?>
  	  	<li class="users_poked_list" id='<?php echo $user->pokeuser_id ?>_poke'>
				...
				<div class="poke_sidebar_list_info">
						...
						<div class="poke_sidebar_list_title" title="<?php echo $user->getTitle(). ' ' . $this->translate('poked you on') . ' ' . date("d M Y", $user->created)?>">
			...
			<div class="poke_sidebar_list_details">
        			<?php echo $this->translate('has poked you');?>
						...
						<?php if($send):?>
							<div title="<?php echo $this->translate('Poke Back');?>" class="poke_sidebar_list_details">
							 	<?php echo $this->htmlLink(array('route' => 'poke_general', 'controller' => 'pokeusers', 'action'=>'pokeuser', 'pokeuser_id' => $user->user_id), $this->translate('Poke Back'), array(
