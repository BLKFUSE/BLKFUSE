 ...
 * @version    $Id: AdminEventsController.php 2017-01-12  00:00:00 socialnetworking.solutions $
...
class Sesadvancedactivity_AdminEventsController extends Core_Controller_Action_Admin
{
  ...
  public function createAction(){
    ...
    $this->_forward('success', 'utility', 'core', array(
          //'smoothboxClose' => 10,
          'parentRefresh' => 10,
          'messages' => array(Zend_Registry::get('Zend_Translate')->_('Custom Notification Created Successfully.'))
      ));
  }
