 ...
 * @version    $Id: AjaxController.php 2017-01-12  00:00:00 socialnetworking.solutions $
...
//    }
  ...
  public function friendsAction(){
    ...
    if( !$viewer->getIdentity() ) {
      ...
      if(!engine_in_array('sespage',$enabledModuleNames) && !engine_in_array('sesgroup',$enabledModuleNames) && !engine_in_array('sesbusiness',$enabledModuleNames)){
