 ...
 */
  ...
  scriptJquery(document).on('click','.sesadv_animation_cls',function(e){
      makeLinkAnimation(scriptJquery(this),e);
  })
  ...
  function makeLinkAnimation(elem,event){
    ...
    if(dataAttr != ""){
        scriptJquery('.sesadv_animation_cls_div').removeAttr('class').addClass('sesadv_animation_cls_div');;
        scriptJquery('.sesadv_animation_cls_div').addClass(dataAttr);
        scriptJquery('.sesadv_animation_cls_div').html('');
        scriptJquery('.sesadv_animation_cls_div').addClass('sesadv_animation_cl_cls');
        scriptJquery('.sesadv_animation_cl_cls').css('left',event.pageX).css('top',event.pageY);
        initSesadvAnimation();
   ...
   function removeAnimationContentSesadv(){
     setTimeout(function () {
       scriptJquery('.sesadv_animation_cls_div').removeAttr('style');
       scriptJquery('.sesadv_animation_cls_div').removeClass('sesadv_animation_cl_cls');
    }, 1500);
  }
	function initSesadvAnimation() {
		/* Icon 1 */
		var el1 = scriptJquery('.sesadvancedactivity-animation-1');
    if(el1.length > 0){
      ...
      /* Icon 1 */
		...
		/* Icon 2 */
		var el2 = scriptJquery('.sesadvancedactivity-animation-2');
   if(el2.length > 0){
		...
		/* Icon 3 */
		var el3 = scriptJquery('.sesadvancedactivity-animation-3');
    if(el3.length > 0){
      new AnimoconSesadv(el3, {
		...
		/* Icon 4 */
		var el4 = scriptJquery('.sesadvancedactivity-animation-4');
    if(el4.length > 0){
      ...
      new AnimoconSesadv(el4, {
		...
		/* Icon 5 */
		var el5 =scriptJquery('.sesadvancedactivity-animation-5');
    if(el5.length > 0){
      ...
      new AnimoconSesadv(el5, {
		...
		/* Icon 6 */
		var el6 = scriptJquery('.sesadvancedactivity-animation-6');
    if(el6.length > 0){
      ...
      new AnimoconSesadv(el6, {
		...
		/* Icon 7 */
		var el7 = scriptJquery('.sesadvancedactivity-animation-7');
    if(el7.length > 0){
      new AnimoconSesadv(el7, {
		...
		/* Icon 8 */
		var el8 = scriptJquery('.sesadvancedactivity-animation-8');
    if(el8.length > 0){
      ...
      new AnimoconSesadv(el8, {
		...
		/* Icon 9 */
		var el9 = scriptJquery('.sesadvancedactivity-animation-9');
    if(el9.length > 0){
      new AnimoconSesadv(el9, {
		...
		/* Icon 10 */
		var el10 = scriptJquery('.sesadvancedactivity-animation-10');
    if(el10.length > 0){
      ...
      new AnimoconSesadv(el10, {
		...
		/* Icon 11 */
		var el11 = scriptJquery('.sesadvancedactivity-animation-11');
    if(el11.length > 0){
      ...
      new AnimoconSesadv(el11, {
		...
		/* Icon 12 */ 
		var el12 = scriptJquery('.sesadvancedactivity-animation-12');
    if(el12.length > 0){
      ...
      new AnimoconSesadv(el12, {
		...
		/* Icon 13 */
		var el13 = scriptJquery('.sesadvancedactivity-animation-13');
    if(el13.length > 0){
      new AnimoconSesadv(el13, {
		...
		/* Icon 14 */
		var el14 = scriptJquery('.sesadvancedactivity-animation-14');
    if(el14.length > 0){
      new AnimoconSesadv(el14, {
		...
		/* Icon 15 */
		var el15 = scriptJquery('.sesadvancedactivity-animation-15');
    if(el15.length > 0){
      ...
      new AnimoconSesadv(el15, {
		...
		/* Icon 16 */
		var el16 = scriptJquery('.sesadvancedactivity-animation-16');
    if(el16.length > 0){
    ...
    if( scriptJquery('.sesadvancedactivity-special-link').length > 0){
    scriptJquery('.sesadv_animation_cl_cls').css('height','200').css('width','200')
		var molinkEl = scriptJquery('.sesadvancedactivity-special-link'),
...
scriptJquery(document).ready(function(){    
	scriptJquery("<div class=\'sesadv_animation_cls_div\'></div>").appendTo("body");
})