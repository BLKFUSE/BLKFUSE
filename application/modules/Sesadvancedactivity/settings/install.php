...
class Sesadvancedactivity_Installer extends Engine_Package_Installer_Module {
  ...
  public function onInstall() {
    ...
    $page_id = $db->select()
      ...
      ->where('name = ?', 'sesadvancedactivity_index_sell')
      ->limit(1)
      ->query()
      ->fetchColumn();
    ...
    if( !$page_id ) {
      ...
      $db->insert('engine4_core_pages', array(
        'name' => 'sesadvancedactivity_index_sell',
        'displayname' => 'SNS - Professional Activity & Comments - Sell Something Page',
      ...
      $db->insert('engine4_core_content', array(
        'type' => 'widget',
        'name' => 'sesadvancedactivity.sell-something',
        'page_id' => $page_id,
