...
('core_admin_main_settings_sesadvancedactivity', 'sesadvancedactivity', 'SNS - Professional Activity & Nested Comments Plugin', '', '{"route":"admin_default","module":"sesadvancedactivity","controller":"settings","action":"index"}', 'core_admin_main_plugins', '', 1),
