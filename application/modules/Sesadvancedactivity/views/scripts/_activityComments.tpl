        ...
        <ul class="sesbasic_clearfix">
          <?php if( $canComment ): ?>
            ...
            <?php if( Engine_Api::_()->getApi('settings', 'core')->core_spam_comment ): // Comments - likes ?>
              <li class="feed_item_option_comment">
              	...
              	<a href="<?php echo $this->url(array('module'=>'sesadvancedactivity','controller'=>'index','action'=>'viewcomment','action_id'=>$action->getIdentity(),'format'=>'smoothbox'),'default',true); ?>" class="openSmoothbox">
                	<i></i>
          ...
          <?php //Show like, comment and share to non loggined member accorditg to admin settings
            ...
            <li class="feed_item_option_like">
              ...
              <a onclick="ajasmoothboxopen('<?php echo $this->escape($this->url(array('module'=> 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'format' => 'smoothbox'), 'default' , true)); ?>');return false;" href="javascript:void(0);" class="openSmoothbox">
                <i></i>
          ...
          <?php if( $action->getTypeInfo()->shareable): ?>
            <?php if( $action->getTypeInfo()->shareable == 1 && $action->attachment_count == 1 && ($attachment = $action->getFirstAttachment()) ): ?>
              <li class="feed_item_option_share">
              	<a href="<?php echo $this->url(array('module' => 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'type' => $attachment->item->getType(), 'id' => $attachment->item->getIdentity(),'action_id'=>$action->getIdentity(), 'format' => 'smoothbox'), 'default', true); ?>" class="openSmoothbox">
                	<i></i>
            ...
            <?php elseif( $action->getTypeInfo()->shareable == 2 ): ?>
              <li class="feed_item_option_share">
              	<a href="<?php echo $this->url(array('module' => 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'type' => $subject->getType(), 'id' => $subject->getIdentity(), 'format' => 'smoothbox','action_id'=>$action->getIdentity()), 'default', true);?>" class="openSmoothbox">
                	<i></i>
                  <span><?php echo $this->translate('Share');?></span>
                </a>
              </li>
            ...
            <?php elseif( $action->getTypeInfo()->shareable == 4 ): ?>
              <li class="feed_item_option_share">
              	<a href="<?php echo $this->url(array('module' => 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'type' => $action->getType(), 'id' => $action->getIdentity(), 'format' => 'smoothbox','action_id'=>$action->getIdentity()), 'default', true);?>" class="openSmoothbox">
                	<i></i>
                  <span><?php echo $this->translate('Share');?></span>
                </a>
              </li>
