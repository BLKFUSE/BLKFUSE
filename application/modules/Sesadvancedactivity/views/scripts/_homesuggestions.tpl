 ...
 * @version    $Id: _homesuggestions.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
...
<a href="javascript:;" class="sesact_addbday_close close_parent_notification_sesadv"><i class="fas fa-times sesbasic_text_light"></i></a>
  ...
  <div class="sesact_sendwish_btns">
     ...
     <?php if(Engine_Api::_()->sesbasic()->hasCheckMessage($birthdayuser)){ ?>
      <a href="<?php echo "messages/compose/to/".$birthdayuser->user_id  ?>" class="openSmoothbox"><i class="fa fa-comments-o"></i><span><?php echo $this->translate('Send Message') ; ?></span></a>
     <?php } ?>
    </div>
</div>
<?php
...
<?php 
 ...
 ?>
<div class="sesact_tip_box sesbasic_clearfix sesbm sesact_addbday centerT parent_notification_sesadv" style="display:block;">
	<a href="javascript:;" class="sesact_addbday_close close_parent_notification_sesadv"><i class="fas fa-times sesbasic_text_light"></i></a>
