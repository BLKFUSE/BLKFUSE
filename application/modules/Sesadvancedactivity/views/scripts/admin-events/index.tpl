...
<?php if(is_countable($this->paginator) &&  engine_count($this->paginator)): ?>
  ...
  <div>
        <?php if(is_countable($this->paginator) &&  engine_count($this->paginator)): ?>
 					 <div class="sesbasic_search_reasult">
    <?php echo $this->translate(array('%s Custom notification found.', '%s Custom notifications found.', $this->paginator->getTotalItemCount()), $this->locale()->toNumber($this->paginator->getTotalItemCount())) ?>
  </div>
  			<?php endif; ?>
        ...
        <?php else:?>
          <div class="tip">
            <span>
              <?php echo "There are no custom notification added by you.";?>
            </span>
          </div>
        <?php endif;?>
      </div>
