 ...
 * @version    $Id: feed-buy-sell.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
      ...
      <div class="sesact_sellitem_popup_photo_container">
      	<div>
            ...
            <?php if($photo) { ?>
          	...
          	<?php } else { ?>
              <img class="selected_image_buysell" src="application/modules/Sesadvancedactivity/externals/images/sell-popup.png" />
          	<?php } ?>
          </div>
        </div>
      </div>
