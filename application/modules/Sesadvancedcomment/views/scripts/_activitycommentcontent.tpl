 ...
 * @version    $Id: _activitycommentcontent.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
...
?>
   <?php if($activitycomments->emoji_id) { ?>
    ...
    <?php if(defined('SESFEEDGIFENABLED') && isset($activitycomments->gif_id)) { ?>
      <div class="gif">
        <?php $image = Engine_Api::_()->getItem('sesfeedgif_image', $activitycomments->gif_id);
        if($image) {
