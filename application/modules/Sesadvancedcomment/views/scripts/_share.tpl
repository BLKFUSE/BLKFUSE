 ...
 * @version    $Id: _share.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
...
<?php } else if($enablesessocialshare && Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('sessocialshare')) { ?>
  ...
  <div class="sesadvcmt_hoverbox"> 
    ...
    <?php foreach($socialicons as $socialicon):  ?>
      ...
      <?php } ?>
    <?php endforeach; ?>
    <?php if(engine_count($socialicons) > 0 && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvancedactivity.enableplusicon', 0)) { ?>
