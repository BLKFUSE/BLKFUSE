 ...
 * @version    $Id: gallery.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
    ...
    <div class='settings sesbasic-form-cont'>
      ...
      <div>
        <div class="sesbasic_search_reasult">
          <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedcomment', 'controller' => 'emotion', 'action' => 'create-gallery'), $this->translate("Create New Pack"), array('class'=>'sesbasic_button fa fa-plus smoothbox')); ?>
        </div>
        <?php if(is_countable($this->paginator) &&  engine_count($this->paginator)): ?>
          <div class="sesbasic_search_reasult">
