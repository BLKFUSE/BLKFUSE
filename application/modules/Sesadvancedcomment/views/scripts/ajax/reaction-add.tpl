 ...
 * @version    $Id: reaction-add.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
...
function sessmoothboxcallback (){
		scriptJquery('#sessmoothbox_main').css('z-index', '101');
	}
</script>
<?php die; ?>
