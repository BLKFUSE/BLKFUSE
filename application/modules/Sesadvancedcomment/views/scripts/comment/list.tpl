 ...
 * @version    $Id: list.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
                ...
                <div class="comment_form sesbasic_clearfix">
                  ...
                  <div class="_sesadvcmt_post_icons sesbasic_clearfix">
                    <span>
                      ...
                      <?php //GIF Work ?>
                      <?php if(defined('SESFEEDGIFENABLED') && engine_in_array('gif', $enableattachement)) { ?>
                 ...
                 <button type="submit" class="disabled post_btn"><i class="fa fa-paper-plane"></i><span style="display:none;"><?php echo $this->translate('POST'); ?></span></button>
              </div>
...
<?php if($this->is_ajax_load){ ?>
  <script type="application/javascript">
      ...
      {
      scriptJquery.post(en4.core.baseUrl+'sesadvancedcomment/comment/list',{is_ajax_load_req:true,id:<?php echo $this->idtype; ?>,type:"<?php echo $this->type ?>"},function(result){
