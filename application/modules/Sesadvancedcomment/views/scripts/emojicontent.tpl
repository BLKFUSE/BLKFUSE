 ...
 * @version    $Id: emojicontent.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
...
<div class="ses_emoji_container_inner sesbasic_clearfix">
  <div class="ses_emoji_container_header sesbasic_clearfix">
    <?php if(engine_count($getGallery) > 0 && $show && engine_in_array('stickers', $enableattachement)): ?>
    ...
    <div class="ses_emoji_container_header_tabs">
      <div class="ses_emoji_tabs owl-theme" id="ses_emoji_tabs">
        ...
        <?php if($show && engine_in_array('stickers', $enableattachement)) { ?>
        
         <a class="_headbtn _headbtn_search sesadv_emotion_btn_clk complete" href="javascript:;" <?php if(engine_count($getGallery) == 0 || empty($enablesearch)): ?> style="display:none;" <?php endif; ?>><i></i></a>
        ...
        <?php $useremoji = Engine_Api::_()->getDbTable('useremotions','sesadvancedcomment')->getEmotion(array('type' => 'user')); 
              ...
              <?php if(Engine_Api::_()->storage()->get($emoji->file_id, '')) { ?>
