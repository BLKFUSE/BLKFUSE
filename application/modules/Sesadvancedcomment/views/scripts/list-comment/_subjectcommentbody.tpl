        ...
        <div class="comment_form_main">
          <div class="comment_form sesbasic_clearfix">
            ...
            <div class="_sesadvcmt_post_icons sesbasic_clearfix">
            	<span>
              <?php if($albumenable && Engine_Api::_()->authorization()->isAllowed('album', null, 'create')  && engine_in_array('photos', $enableattachement)){ ?>
            ...
            <?php if($videoenable && Engine_Api::_()->authorization()->isAllowed('video', $viewer, 'create') && engine_in_array('videos', $enableattachement)){ ?>
