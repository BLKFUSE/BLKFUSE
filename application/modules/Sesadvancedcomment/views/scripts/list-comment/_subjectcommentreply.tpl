 ...
 * @version    $Id: _subjectcommentreply.tpl 2017-01-12 00:00:00 socialnetworking.solutions $
  ...
  <?php endif ?>
      ...
      <?php endif; ?>
        <?php if(strlen(preg_replace("/(\\\u[0-9a-f]{4})+?|\s+/","",strip_tags($content))) && $islanguageTranslate){ ?>
         <li class="comments_reply_translate"> <a href="javascript:void(0);" class="comments_translate_link floatR" onClick="socialSharingPopUp('https://translate.google.com/#auto/<?php echo $languageTranslate; ?>/<?php echo urlencode(strip_tags($commentreply->body)); ?>','Google');return false;"><?php echo $this->translate("Translate"); ?></a></li>
         <li class="sep">&middot;</li>
   <?php } ?>
