...
('core_admin_main_plugins_sesadvpmnt', 'sesadvpmnt', 'SNS - Stripe Payment Gateway Plugin', '', '{"route":"admin_default","module":"sesadvpmnt","controller":"settings"}', 'core_admin_main_plugins', '', 999),
