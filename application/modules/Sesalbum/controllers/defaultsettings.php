...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Manage Albums Page',
      'title' => 'My Albums',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Photo View Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Album View Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Browse Photos Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Photos Home Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Album Create Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Browse Tags Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Albums Welcome Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Albums Home Page',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $main_left_id,
      'order' => 8,
      'params' => '{"tableName":"album","criteria":"5","info":"most_download","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"view_type":"2","title_truncation":"20","height":"160","gridblock":"12","limit_data":"3","title":"Most Downloaded Albums","nomobile":"0","name":"sesalbum.featured-sponsored"}',
  ));
	$db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'sesalbum.featured-sponsored',
      ...
      'parent_content_id' => $main_left_id,
      'order' => 9,
      'params' => '{"tableName":"album","criteria":"5","info":"most_liked","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"view_type":"2","title_truncation":"20","height":"160","gridblock":"12","limit_data":"3","title":"Most Liked Albums","nomobile":"0","name":"sesalbum.featured-sponsored"}',
  ));
	$db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'sesalbum.featured-sponsored',
      ...
      'parent_content_id' => $main_left_id,
      'order' => 10,
      'params' => '{"tableName":"album","criteria":"5","info":"recently_liked","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"view_type":"2","title_truncation":"20","height":"162","gridblock":"12","limit_data":"3","title":"Most Viewed Albums","nomobile":"0","name":"sesalbum.featured-sponsored"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'sesalbum.browse-search',
...
$db->insert('engine4_core_content', array(
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $main_right_id,
      'order' => 21,
      'params' => '{"tableName":"album","criteria":"5","info":"most_favourite","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"view_type":"2","title_truncation":"20","height":"155","gridblock":"12","limit_data":"3","title":"Most Favourite Album","nomobile":"0","name":"sesalbum.featured-sponsored"}'
  ));
  // Insert browse menu
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      ...
      'parent_content_id' => $main_right_id,
      'order' => 22,
      'params' => '{"tableName":"album","criteria":"5","info":"most_commented","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"view_type":"2","title_truncation":"20","height":"151","gridblock":"12","limit_data":"3","title":"Most Commented Albums","nomobile":"0","name":"sesalbum.featured-sponsored"}',
  ));
	$db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'sesalbum.recently-viewed-item',
      ...
      'parent_content_id' => $main_right_id,
      'order' => 23,
      'params' => '{"category":"album","criteria":"on_site","insideOutside":"inside","fixHover":"hover","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","downloadCount","photoCount","likeButton","favouriteButton"],"title_truncation":"20","height":"150","gridblock":"12","limit_data":"2","title":"Recently Viewed Albums","nomobile":"0","name":"sesalbum.recently-viewed-item"}',
  ));
}
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Browse Categories Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Category View Page',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Advanced Photos - Browse Albums Page',
...
');
$db->query('ALTER TABLE `engine4_sesalbum_albums` ADD `package_id` INT(11) NOT NULL DEFAULT "0";');
$db->query('ALTER TABLE `engine4_sesalbum_photos` ADD `package_id` INT(11) NOT NULL DEFAULT "0";');
