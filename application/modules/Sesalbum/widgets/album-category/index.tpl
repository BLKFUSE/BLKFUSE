...
<div class="sesbasic_clearfix">
    <div class="sesalbum_catbase_list_head sesbm" style="display:none;"><?php echo $this->translate("All Categories"); ?></div>
  <div class="row sesbasic_clearfix clear sesbasic_bxs justify-content-center">
    <?php foreach( $this->paginator as $item ):  ?>
    <div class="col-lg-<?php echo $this->gridblock; ?> col-md-4 col-sm-6 col-12">
      <div class="sesalbum_category_grid sesbm" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
