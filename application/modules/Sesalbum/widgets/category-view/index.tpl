...
<?php if($this->show_subcat == 1 && engine_count($this->innerCatData)>0){ ?>
  <div class="sesbasic_clearfix">
    <ul class="row sesalbum_category_grid_listing sesbasic_clearfix clear sesbasic_bxs">	
      <?php foreach( $this->innerCatData as $item ):  ?>
       <li class="col-lg-<?php echo $this->gridblock; ?> col-md-6 col-sm-6 col-12">
        <div class="sesalbum_category_grid sesbm" style="height:<?php echo is_numeric($this->heightSubcat) ? $this->heightSubcat.'px' : $this->heightSubcat ?>;">
      ...
      <?php } ?>
               ...
               <?php if(!$close){  ?><div class="sesalbum_albumlist_column_small floatL"> <?php } ?>
                    <div class="sesalbum_cat_album_list">
                     ...
                     <div class="sesalbum_thumb  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.sesalbum',1) && Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable(array('epaidcontent')) && Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.allow',1) && Engine_Api::_()->epaidcontent()->isViewerPlanActive($item)) { ?> paid_content <?php } ?>">
