...
class Sesalbum_Widget_TabbedWidgetController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if (isset($_POST['searchParams']) && $_POST['searchParams']) {
		...
		$this->view->gridblock = $gridblock = isset($params['gridblock']) ? $params['gridblock'] : $this->_getParam('gridblock', '6');
		...
		if(!$is_ajax){
			//order tabs
			if(is_countable($defaultOptionsArray) && engine_count($defaultOptionsArray) == 0)
