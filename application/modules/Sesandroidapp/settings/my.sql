...
('core_admin_main_plugins_sesandroidapp', 'sesandroidapp', 'SNS - Android Native...', '', '{"route":"admin_default","module":"sesandroidapp","controller":"settings","action":"index"}', 'core_admin_main_plugins', '', 999),
