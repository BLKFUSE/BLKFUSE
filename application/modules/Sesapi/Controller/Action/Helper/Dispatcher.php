...
class Sesapi_Controller_Action_Helper_Dispatcher extends Zend_Controller_Action_Helper_Abstract {
  ...
  public function preDispatch()
  {
    ...
    if(!empty($_SESSION['sesbasic_location_data'])){
      $_COOKIE["sesbasic_location_data"] = $_SESSION['sesbasic_location_data'];
      $_COOKIE["sesbasic_location_lat"] = $_SESSION['sesbasic_location_lat'];
      $_COOKIE["sesbasic_location_lng"] = $_SESSION['sesbasic_location_lng'];
    }
