...
return $result;
  ...
  public function joinAction()
  {
    ...
    try
    {
      ...
      $db->commit();
      Engine_Api::_()->getApi('response','sesapi')->sendResponse(array('error'=>'0','error_message'=>'', 'result' => array('success_message' => "You are now a member of this group.")));
    }
    catch( Exception $e )
    {
      $db->rollBack();
  ...
  public function leaveAction() {
    ...
    try
    {
      ...
      $db->commit();
      Engine_Api::_()->getApi('response','sesapi')->sendResponse(array('error'=>'0','error_message'=>'', 'result' => array('success_message' => "You have successfully left this group.")));
    }
    catch( Exception $e )
    {
      $db->rollBack();
