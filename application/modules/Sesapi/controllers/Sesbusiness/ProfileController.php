...
class Sesbusiness_ProfileController extends Sesapi_Controller_Action_Standard
{
    ...
    public function businessPackage() {
        ...
        if (!engine_count($packageMemberLevel) || !Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinesspackage.enable.package', 0))
            return true;
    ...
    public function editAction(){
        ...
        //if (!$this->getRequest()->isPost()) {
            ...
            foreach ($roles as $role) {
                ...
                if (isset($form->auth_poll->options[$role]) && $auth->isAllowed($business, $role, 'poll'))
                ...
                if (isset($form->auth_forum->options[$role]) && $auth->isAllowed($business, $role, 'offer'))
