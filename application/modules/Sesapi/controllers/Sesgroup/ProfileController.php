...
class Sesgroup_ProfileController extends Sesapi_Controller_Action_Standard
{
    ...
    public function groupPackage() {
        ...
        if (!engine_count($packageMemberLevel) || !Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgrouppackage.enable.package', 0))
            return true;
    ...
    public function editAction(){
        ...
        //if (!$this->getRequest()->isPost()) {
            ...
            foreach ($roles as $role) {
              ...
              if (isset($form->auth_poll->options[$role]) && $auth->isAllowed($group, $role, 'poll'))
