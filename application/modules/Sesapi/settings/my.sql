...
('core_admin_main_plugins_sesapi', 'sesapi', 'SNS - SocialEngine REST APIs Plugin', '', '{"route":"admin_default","module":"sesapi","controller":"settings","action":"index"}', 'core_admin_main_plugins', '', 999),
