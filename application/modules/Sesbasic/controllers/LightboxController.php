...
class Sesbasic_LightboxController extends Core_Controller_Action_Standard {
  ...
  public function imageViewerDetailAction() {
    ...
    if($getParams['id'] == 'group-community') {
      $getParams['module'] = 'sesgroup';
		}else if($getParams['id'] == 'page-directory') {
      $getParams['module'] = 'sespage';
		} else if($getParams['id'] == 'Sesarticles') {
      $getParams['module'] = 'sesarticle';
		} else if($getParams['id'] == 'Seslistings') {
      $getParams['module'] = 'seslisting';
		} else if($getParams['id'] == 'Sesrecipes') {
      ...
      $getParams['module'] = 'sesevent';
		...
		if(!engine_in_array($getParams['module'],array('sescontest','sesproduct'))){
      if(!$getModuleData){
        echo json_encode(array('status'=>false));die;
      }
    ...
    if($getParams['module'] == "sescontest") {
      $getModuleData[0]['content_type_photo'] = 'participant';
      ...
      $item = Engine_Api::_()->getItem('participant',$getParams['id']);
    ...
    if( isset($getModule) && engine_in_array($getModule['module'], array('sesalbum', 'album'))) {
