 ...
 <div class="sesbasic_tooltip_info">
  ...
  <?php } ?>
	<div class="sesbasic_tooltip_stats">
	  <?php if(engine_in_array('like',$this->moduleEnableTip) && !empty($subject->like_count)):?>
	  ...
	  <?php endif;?>
	  <?php if(engine_in_array('view',$this->moduleEnableTip) && !empty($subject->view_count)):?>
	  ...
	  <?php endif;?>
    <?php if(engine_in_array('comment',$this->moduleEnableTip) && !empty($subject->comment_count)):?>
