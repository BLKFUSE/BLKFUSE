...
<div class="sescontest_info_tip sesbasic_bxs">
	<div class="sescontest_info_tip_cover">
      <span class="sescontest_info_tip_cover_img" <?php if(engine_in_array('coverphoto',$this->globalEnableTip) && engine_in_array('coverphoto',$this->moduleEnableTip)):?>style="background-image:url('<?php echo $contest->getCoverPhotoUrl() ?>');"<?php endif;?>></span>
    <div class="sescontest_info_tip_cover_cont">
      <?php if(engine_in_array('media',$this->moduleEnableTip)): ?>
      ...
      <div class="sescontest_info_tip_cover_info">
        ...
        <?php if(engine_in_array('category',$this->globalEnableTip) && engine_in_array('category',$this->moduleEnableTip) && $category):?>
          <div class="sescontest_info_tip_date"><a href="<?php echo $category->getHref();?>"><?php echo $category->category_name;?></a> &middot;<?php endif;?><?php if(engine_in_array('entries',$this->moduleEnableTip)): ?><?php echo $contest->join_count.' ';?><?php echo $this->translate(array('Entry', 'Entries', $contest->join_count), $this->locale()->toNumber($contest->join_count)) ?><?php endif;?></div>
      </div>
    </div>
  </div>
	<div class="sescontest_info_tip_content sesbasic_clearfix">
      <?php if(engine_in_array('description',$this->moduleEnableTip)): ?>
    ...
    <?php if(engine_count($this->friends) > 0):?>
    ...
    <?php endif;?>
    <?php if(engine_count($this->entries) > 0):?>
    ...
    <?php endif;?>
    <?php if(engine_in_array('joinNow',$this->moduleEnableTip)): ?>
  ...
  <?php if(engine_in_array('socialshare',$this->moduleEnableTip)): ?>
