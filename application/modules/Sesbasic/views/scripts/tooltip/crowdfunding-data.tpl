...
<div class="sescrowdfunding_info_tip sesbasic_bxs">
  <div class="sescrowdfunding_info_tip_cover"> <span class="sescrowdfunding_info_tip_cover_img" <?php if(engine_in_array('coverphoto',$this->moduleEnableTip)):?> style="background-image:url(<?php echo $subject->getPhotoUrl(); ?>);" <?php endif; ?>></span>
    <div class="sescrowdfunding_info_tip_cover_cont">
			<?php if(engine_in_array('ownerhoto',$this->moduleEnableTip)):?>
      ...
      <div class="sescrowdfunding_info_tip_cover_info">
        ...
        <?php if(engine_in_array('category',$this->moduleEnableTip)):?>
  ...
  <?php if(engine_in_array('des',$this->moduleEnableTip)):?>
  ...
  <div class="sesbasic_tooltip_footer sesbasic_clearfix sesbm clear">
		<?php if(engine_in_array('stats',$this->moduleEnableTip)):?>
    <div class="floatL">
    ...
    <div class="floatR">
      ...
      ?>
      <?php endif; ?>
      <?php if(engine_in_array('likebutton',$this->moduleEnableTip)):?>
        <!--Like Button--> 
