...
class Sescommunityads_PaymentController extends Core_Controller_Action_Standard
{
  ...
  public function chargeAction(){
    ...
    try { 
      ...
      $this->view->transactionData = $plugin->createAdTransaction($this->_user,
  ...
  public function getCreditCode($item,$package){
    return 'credit'.'-sescommunityads-'.$package->package_id.'-'.$item->sescommunityad_id;
  }
  public function getCouponSessionCode($item,$package){
    return $package->getType().'-'.$package->package_id.'-'.$item->getType().'-'.$item->sescommunityad_id.'-1';
  }
