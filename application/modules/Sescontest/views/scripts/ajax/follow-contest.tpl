 ...
 * @version    $Id: follow-contest.tpl  2017-12-01 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    (scriptJquery.ajax({
      method: 'post',
      'url': en4.core.baseUrl + 'sescontest/ajax/follow-contest/contest_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('People who Followed this contest') ?>
