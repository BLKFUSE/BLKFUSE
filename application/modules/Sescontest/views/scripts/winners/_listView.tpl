...
<?php else:?>
  <?php $canIntegrate = 0;?>
<?php endif;?>
<div class="sescontest_winners_list_item sesbasic_clearfix">
      ...
      <div class="_details sesbasic_clearfix">
        <?php if($owner && isset($this->ownerPhotoActive)):?>
          <div class="_ownerphoto">
            <?php if(isset($owner->photo_id) && $owner->photo_id):?>
        ...
        <div>
          ...
          <div class="_stats sesbasic_text_light">
            ...
            <?php if(isset($this->voteCountActive) && (!$contest->resulttime || strtotime($contest->resulttime) <= time())):?>
              <span title="<?php echo $this->translate(array('%s Vote', '%s Votes', $entry->vote_count), $this->locale()->toNumber($entry->vote_count)) ?>"><i class="far fa-hand-point-up"></i><span><?php echo $entry->vote_count;?></span></span>
            <?php endif;?>
