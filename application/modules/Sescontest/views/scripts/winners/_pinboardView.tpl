...
<?php else:?>
  <?php $canIntegrate = 0;?>
<?php endif;?>
<div class="sesbasic_pinboard_item sescontest_winners_pinboard_item sesbasic_bxs" style="width:<?php echo $width ?>px;">
      ...
      <?php endif;?>
        <div class="_owner sesbasic_clearfix">
          <?php if(isset($this->ownerPhotoActive)):?>
            <div class="_img">
              <?php if($owner && isset($owner->photo_id)):?>
								<?php $photo = Engine_Api::_()->storage()->get($owner->photo_id); ?>
								<?php if($photo) { ?>
