  ...
  <div class="generic_layout_container">
    <div class="sescontestpackage_payment_process">
      ...
      <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sescredit')) { ?>
        <div class="sescontestpackage_payment_process"><?php  echo $this->partial('apply_credit.tpl','sescredit',array('id'=>$this->package->package_id,'moduleName'=>'sescontestpackage','item_price'=>$this->itemPrice,'item_id'=>$this->item->contest_id)); ?></div> 
      <?php } ?>
    </div>
  </div>
</div>
