...
class Sescredit_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Sescredit_Model_Usergateway';
  ...
  public function getEnabledGatewayCount()
  {
	...
	public function getUserGateway($params = array()){
			$select = $this->select()->from($this->info('name'))->where('user_id =?',$params['owner_id']);
