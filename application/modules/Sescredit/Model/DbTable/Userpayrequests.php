...
class Sescredit_Model_DbTable_Userpayrequests extends Engine_Db_Table {

  protected $_name = 'sescredit_userpayrequests';
  protected $_rowClass = "Sescredit_Model_Userpayrequest";

  public function getSescreditRequests($params = array()) {
