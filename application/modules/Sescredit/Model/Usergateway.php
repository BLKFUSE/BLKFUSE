...
class Sescredit_Model_Usergateway extends Core_Model_Item_Abstract {
  ...
  public function getPlugin() {
    ...
    if( null === $this->_plugin ) {
			$class = 'Sescredit_Plugin_Gateway_Credit_PayPal';
			Engine_Loader::loadClass('Sescredit_Plugin_Gateway_Credit_PayPal');
