...
foreach (Engine_Api::_()->getDbTable('levels', 'authorization')->fetchAll() as $level) {
  $form = new Sescredit_Form_Admin_Settings_Level(array(
      'public' => ( engine_in_array($level->type, array('public')) ),
      'moderator' => (engine_in_array($level->type, array('admin', 'moderator'))),
  ));
  $values = $form->getValues();
  $valuesForm = $permissionsTable->getAllowed('sescredit', $level->level_id, array_keys($form->getValues()));
  ...
  try {
    ...
    $permissionsTable->setAllowed('sescredit', $level->level_id, $values, '', $nonBooleanSettings);
    // Commit
    $db->commit();
  } catch (Exception $e) {
    $db->rollBack();
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Manage Credit Points Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Transactions Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Credit Listing & Information Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Help & Learn More Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Badges Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
// Insert page
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SNS - Credits - Leaderboard Page',
      'title' => '',
      'description' => '',
      'custom' => 0,
  ));
...
$db->query('INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES ("sescredit_main_managecashcredit", "sescredit", "Manage Cash Credits", "Sescredit_Plugin_Menus", \'{"route":"sescredit_general","action":"payment-requests"}\', "sescredit_main", "", 99),
...
$db->query("DROP TABLE IF EXISTS `engine4_sescredit_userpayrequests`;");
$db->query('CREATE TABLE IF NOT EXISTS `engine4_sescredit_userpayrequests` (
...
$db->query("DROP TABLE IF EXISTS `engine4_sescredit_usergateways`;");
$db->query('CREATE TABLE IF NOT EXISTS `engine4_sescredit_usergateways` (
