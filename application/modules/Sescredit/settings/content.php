...
return array(
    array(
        ...
        'category' => 'SNS - Credits & Activity / Reward Points Plugin',
        'type' => 'widget',
        'name' => 'sescredit.my-points',
    ),
    array(
        'title' => 'SNS - Credits - Upgrade Membership',
    ...
    array(
        'title' => 'SNS - Credits - Purchase Points',
    ...
    array(
        'title' => 'SNS - Credits - Recent Activity',
    ...
    array(
        'title' => 'SNS - Credits - Send Point to Friend',
    ...
    array(
        'title' => 'SNS - Credits - Referral Signup',
    ...
    array(
        'title' => 'SNS - Credits - Terms & Conditions',
    ...
    array(
        'title' => 'SNS - Credits - How To Earn Point',
    ...
    array(
        'title' => 'SNS - Credits - My Transactions',
    ...
    array(
        'title' => 'SNS - Credits - My Points Information',
    ...
    array(
        'title' => 'SNS - Credits - Credit Points Details & Information',
    ...
    array(
        'title' => 'SNS - Credits - Navigation Menu',
    ...
    array(
        'title' => 'SNS - Credits -  Transaction Browse Search',
    ...
    array(
        'title' => 'SNS - Credits - Browse Top Members',
    ...
    array(
        'title' => 'SNS - Credits - Help And Learn',
