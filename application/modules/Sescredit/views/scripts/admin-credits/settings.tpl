    ...
    <tbody>
			<thead>
				<tr>
                    ...
                    <th style="width:40%;" class="admin_table_centered">Status</td>
      ...
      <?php foreach ($this->modules as $module): ?>
        ...
        <tr id="moduleid-<?php echo $module->name; ?>" data-id="<?php echo $module->name; ?>">
          ...
          <td style="text-align:center;"><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sescredit', 'controller' => 'credits', 'action' => 'show-parent-type', 'plugin' => $module->name), $this->translate('Edit'), array('class' => 'smoothbox')) ?> 
          </td>
        </tr>
        <?php $subModules = Engine_Api::_()->getDbTable('modulesettings', 'sescredit')->getModuleChild(array('parent_id' => $module->name));?>
        <?php if(engine_count($subModules) > 0):?>
          <?php foreach ($subModules as $subModule):  ?>
            <tr id="moduleid-<?php echo $subModule->name; ?>" data-id="<?php echo $subModule->name; ?>">
            ...
            <?php endif; ?>
              ...
              <td style="text-align:center;"><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sescredit', 'controller' => 'credits', 'action' => 'show-parent-type', 'plugin' => $subModule->name), $this->translate('Edit'), array('class' => 'smoothbox')) ?>  
              </td>
            </tr>
          <?php endforeach; ?>
        <?php endif;?>
