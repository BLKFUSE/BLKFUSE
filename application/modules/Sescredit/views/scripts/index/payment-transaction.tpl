											...
											<?php foreach ($this->paymentRequests as $item): ?>
												<tr>
													...
													<td class="table_options">
														<?php echo $this->htmlLink($this->url(array('action' => 'detail-payment', 'id' => $item->userpayrequest_id), 'sescredit_general', true), $this->translate(""), array('title' => $this->translate("View Details"), 'class' => 'openSmoothbox sesbasic_icon_view')); ?>
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
