    ...
    <?php foreach($this->paginator as $member):?>
      <li class="sescredit_browse_members_item sesbasic_clearfix">
        ...
        <div class="_cont">
          ...
          <div class="_points">
            <span title="<?php echo $this->translate('Credit Points'); ?>"><i class="sescredit_icon16 sescredit_icon_points"></i><span><?php echo $member->total_credit;?></span></span>
            <span title="<?php echo $this->translate('Badges'); ?>"><i class="sescredit_icon16 sescredit_icon_badge"></i><span><?php echo !empty($member->badgeCount) ? $member->badgeCount : 0;?></span></span>
          </div>
        </div>
        <div class="_buttons">
...
//     requestViewMore_<?php echo $randonNumber; ?>.cancel();
    requestViewMore_<?php echo $randonNumber; ?> = scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        scriptJquery('#sescredit_top_members').append(responseHTML);console.log(scriptJquery('#sescredit_top_members'));
