            ...
            <div class="col-lg-7 col-md-12 col-12">
              <div class="banner_left">
                <div>
                  ...
                  <a href="#earn_credits" class="how_it_works"><i class="far fa-play-circle" aria-hidden="true"></i><?php echo $this->translate(' How to Earn Credits');?></a> </div>
              </div>
            </div>
            <div class="col-lg-5">
              <div class="banner_right"> <img src="./application/modules/Sescredit/externals/images/man-happy.png"/> </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="_container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-12">
            <div class="earn_left"> <img src="./application/modules/Sescredit/externals/images/badges.png" alt=""/> </div>
          </div>
          <div class="col-lg-6 col-md-6 col-12">
    ...
    <div class="join_us sesbasic_bxs sesbasic_clearfix" style="background-image: url(application/modules/Sescredit/externals/images/money.png);">
      <div class="_container">
        <div class="_inner_join">
          ...
          <a href="<?php echo $this->signupURL;?>" data-href="signup" class="how_it_works"><?php echo $this->translate('Get Started Now');?></a> </div>
      </div>
    </div>
        ...
        <div class="waysto_earn_head">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/activity.png" alt=""/>
                <div class="_title"><?php echo $this->translate('For New Activity');?></div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/deletion.png" alt=""/>
                <div class="_title"><?php echo $this->translate('On Activity Deletion');?></div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/affiliation.png" alt=""/>
                <div class="_title"><?php echo $this->translate('Inviter Affiliation');?></div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/friend.jpg" alt=""/>
        ...
        <div class="waysto_earn_bottom">
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/purchase.png" alt=""/>
                <div class="_title"><?php echo $this->translate('Received from Friends');?></div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/upgrade.png" alt=""/>
                <div class="_title"><?php echo $this->translate('On Membership Upgrade');?></div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <div class="ear_box"> <img src="./application/modules/Sescredit/externals/images/site.png" alt=""/>
...
<script type="text/javascript">
  scriptJquery("a.how_it_works").click(function(event) {
    event.preventDefault();
  var divid = scriptJquery(this).attr("href");
  var datahref = scriptJquery(this).attr("data-href");
  if(datahref == 'signup') {
			window.location.href = divid;
  } else {
		scriptJquery('html, body').animate({
				scrollTop: scriptJquery(divid).offset().top - 30
		}, 1300);
  }
  });
</script>
