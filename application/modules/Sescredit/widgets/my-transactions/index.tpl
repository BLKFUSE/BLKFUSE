          ...
          <?php foreach($this->paginator as $transaction): ?>
            <div class="_mytransactionstable_item">
              ...
              <?php elseif($transaction->point_type == 'credit'):?>
                <div class="_activitytype"><?php echo $this->translate("Credit");?></div>
              <?php elseif($transaction->point_type == 'deduction'):?>
                <div class="_activitytype"><?php echo $this->translate("Deduction");?></div>
              <?php else:?>
...
<script type='text/javascript'>
  ...
  function viewMore_<?php echo $randonNumber; ?> (){
    ...
    scriptJquery('.activity_transaction_noresult').remove();
...
//     requestViewMore_<?php echo $randonNumber; ?>.cancel();
    requestViewMore_<?php echo $randonNumber; ?> = scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        scriptJquery('#sescredit_transaction_loading').hide();
        ...
        if(document.getElementById('loadingimgsescredit-wrapper'))
        scriptJquery('#loadingimgsescredit-wrapper').hide();
        document.getElementById('loading_image_<?php echo $randonNumber; ?>').style.display = 'none';
        scriptJquery('body').append('<div id="sescredit_hideshow_table" style="display:none;">'+responseHTML+'<div>');
        if(scriptJquery('#sescredit_hideshow_table').find('.activity_transaction_noresult').length) {
          scriptJquery('#sescredit_table_contaner_<?php echo $randonNumber; ?>').parent().append(responseHTML);
        }else {
          scriptJquery('#sescredit_table_contaner_<?php echo $randonNumber; ?>').show();
          
          scriptJquery('#activity-transaction_<?php echo $randonNumber; ?>').append(responseHTML);
          
        }
        scriptJquery('#sescredit_hideshow_table').remove();
      }
    });
    return false;
  }
