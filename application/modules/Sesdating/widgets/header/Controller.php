...
class Sesdating_Widget_HeaderController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $defaultoptn = array('search','miniMenu','mainMenu','logo', 'socialshare');
		$loggedinHeaderCondition = unserialize($settings->getSetting('sesdating.header.loggedin.options', 'a:4:{i:0;s:6:"search";i:1;s:8:"miniMenu";i:2;s:8:"mainMenu";i:3;s:4:"logo";}'));
		$nonloggedinHeaderCondition = unserialize($settings->getSetting('sesdating.header.nonloggedin.options','a:4:{i:0;s:6:"search";i:1;s:8:"miniMenu";i:2;s:8:"mainMenu";i:3;s:4:"logo";}'));
