 ...
 * @version    $Id: Level.php 2017-01-12  00:00:00 socialnetworking.solutions $
  ...
  public function init() {
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('Radio', 'enablefeedbg', array(
        ...
        'description' => 'Do you want to enable the background images in the status updates and activity feeds of your website for the users of this member level? Users will be able to add background images in their status updates from the Member Home Page only. If Yes, then you can choose the order of the Backgrounds to be shown in the "SNS - Advanced Activity Feed" widget placed on the Member Home page.',
        'multiOptions' => array(
            '1' => 'Yes',
            '0' => 'No',
        ),
