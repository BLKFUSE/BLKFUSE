 ...
 * @version    $Id: _reviewsidebarWidgetData.tpl 2016-05-25 00:00:00 socialnetworking.solutions $
...
<?php if($this->view_type == 'list'){ ?>
  <li class="sesmember_review_sidebar_list <?php if($this->image_type == 'rounded'):?>sesmember_sidebar_image_rounded<?php endif;?> sesbasic_clearfix">
    <?php echo $this->htmlLink($reviewOwner, $this->itemPhoto($reviewOwner, 'thumb.normal')); ?>
    <div class="sesmember_review_sidebar_list_info">
      ...
      <?php endif;?>  
        ...
        <?php if(isset($review->comment_count) && $this->commentActive):?>
          <span><i class="far fa-comments"></i><span><?php echo $review->comment_count;?></span></span>
        <?php endif;?>
      </div>
