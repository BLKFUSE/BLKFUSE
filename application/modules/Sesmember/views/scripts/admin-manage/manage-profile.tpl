 ...
 * @version    $Id: manage-profile.tpl 2016-05-25 00:00:00 socialnetworking.solutions $
...
<div>
  ...
  foreach (Engine_Api::_()->getDbtable('levels', 'authorization')->fetchAll() as $level) {
      ...
      <?php if($levelValues){ 
        ...
        <div class="tip">
    <span>
      <?php echo $this->translate("There are no member level remaining to create profile page.
