...
class Sesmember_Widget_PopularFeaturedVerifiedReviewsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $show_criterias = isset($params['show_criterias']) ? $params['show_criterias'] : $this->_getParam('show_criteria', array('like', 'title', 'comment' , 'view', 'featuredLabel', 'verifiedLabel', 'likeButton', 'rating', 'description', 'by'));
