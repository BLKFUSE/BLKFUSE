     ...
     <table class='admin_table'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="nowrap"><?php echo $this->htmlLink($item->getHref(), $this->translate(Engine_Api::_()->sesbasic()->textTruncation($item->getTitle(),20)), array('title' => $this->translate($item->getTitle()), 'target' => '_blank')) ?></td> 
          ...
          <td class="nowrap"><?php echo $this->translate($item->creation_date) ?></td>
          <td class="nowrap">
