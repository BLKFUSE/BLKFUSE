...
<script type="text/javascript">
  function printData() {
    document.getElementById('lyricsprint').style.display = "none";
    window.print();
    setTimeout(function() {
      document.getElementById('lyricsprint').style.display = "block";
    }, 400);
  }
</script>
<div class="sesmusic_print_wrapper">
  <div id="lyricsprint" class="sesmusic_options_buttons sesmusic_print_button">
    <a href="javascript:void(0);" class="sesbasic_icon_print" onclick="printData()"><?php echo $this->translate('Take Print') ?></a>
  </div>
