...
<?php if(is_countable($this->paginator) && engine_count($this->paginator) > 0): ?>
  ...
  <?php foreach ($this->paginator as $song): ?>
    <?php if(!empty($song)): ?>
    <li class="sesmusic_artist_songslist sesbasic_clearfix <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.sesmusic',1) && Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable(array('epaidcontent')) && Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.allow',1) && Engine_Api::_()->epaidcontent()->isViewerPlanActive($song)) { ?> paid_content <?php } ?>">
  ...
  <?php elseif($this->viewType == 'gridview'): ?>
    <?php foreach( $this->paginator as $item ):  ?>
      ...
      <li id="thumbs-photo-<?php echo $item->photo_id ?>" class="sesmusic_item_grid sesbasic_bxs <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.sesmusic',1) && Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable(array('epaidcontent')) && Engine_Api::_()->getApi('settings', 'core')->getSetting('epaidcontent.allow',1) && Engine_Api::_()->epaidcontent()->isViewerPlanActive($album)) { ?> paid_content <?php } ?>" style="width:<?php echo str_replace('px','',$this->width).'px'; ?>;"> 
