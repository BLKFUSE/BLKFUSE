...
function showCategory(id) {
  if(document.getElementById('subcategory_' + id)) {
    if (document.getElementById('subcategory_' + id).style.display == 'block') {
      scriptJquery('#sesmusic_toggle_' + id).removeClass('cattoggel cattoggeldown');
      scriptJquery('#sesmusic_toggle_' + id).addClass('cattoggel cattoggelright');
      document.getElementById('subcategory_' + id).style.display = 'none';
    } else {
      scriptJquery('#sesmusic_toggle_' + id).removeClass('cattoggel cattoggelright');
      scriptJquery('#sesmusic_toggle_' + id).addClass('cattoggel cattoggeldown');
  ...
  if(document.getElementById('subsubcategory_' + id)) {
    if (document.getElementById('subsubcategory_' + id).style.display == 'block') {
      scriptJquery('#sesmusic_subcat_toggle_' + id).removeClass('cattoggel cattoggeldown');
      scriptJquery('#sesmusic_subcat_toggle_' + id).addClass('cattoggel cattoggelright');      
      document.getElementById('subsubcategory_' + id).style.display = 'none';
    } else {
      scriptJquery('#sesmusic_subcat_toggle_' + id).removeClass('cattoggel cattoggelright');
      scriptJquery('#sesmusic_subcat_toggle_' + id).addClass('cattoggel cattoggeldown');
