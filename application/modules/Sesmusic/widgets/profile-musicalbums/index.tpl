...
<?php endif; ?>
          ...
          $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity(); ?>
              <li id="music_playlist_item_<?php echo $photo->getIdentity() ?>" class="sesmusic_playlist_browse_listing sesbasic_clearfix">
...
<?php if($this->loadOptionData == 'auto_load'){ ?>
        ...
        if(fromtop_<?php echo $randonNumber; ?> > heightOfContentDiv_<?php echo $randonNumber; ?> - 100 && sesBasicAutoScroll('#view_more_<?php echo $randonNumber; ?>').css('display') == 'block' ){
          if(document.getElementById('feed_viewmore_link_<?php echo $randonNumber; ?>'))
