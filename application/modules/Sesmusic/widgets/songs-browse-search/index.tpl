...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    AutocompleterRequestJSON('title_song', "<?php echo $this->url(array('module' => 'sesmusic', 'controller' => 'index', 'action' => 'search', 'actonType' => 'browse', 'sesmusic_commonsearch' => 'sesmusic_albumsong'), 'default', true) ?>", function(selecteditem) {
