		...
		if(valueTab){
			 ...
			 requestTab_<?php echo $randonNumber; ?> = scriptJquery.ajax({
				...
				success: function(responseHTML) {
					...
					scriptJquery('#tabbed-widget-songs_<?php echo $randonNumber; ?>').append(responseHTML);
  ...
  function viewMore_<?php echo $randonNumber; ?> () {
    ...
    en4.core.request.send(scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        ...
        scriptJquery('#tabbed-widget-songs_<?php echo $randonNumber; ?>').append(responseHTML);    if(document.getElementById("view_more_<?php echo $randonNumber; ?>"))
