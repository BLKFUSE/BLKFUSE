          ...
          <div class="sespymk_list_sidebar_item_inner">
            ...
            <div class="sespymk_list_item_cont">
              ...
              <div class="sespymk_list_item_btn">
                ...
                <a href="javascript:void(0);" onclick='widget_request_send("reject", <?php echo $this->string()->escapeJavascript($notification->getSubject()->getIdentity()) ?>, <?php echo $notification->notification_id ?>, event, "<?php echo $tokenName; ?>", "<?php echo $tokenValue; ?>")'><i class="fas fa-times"></i></a>
              </div>
            </div>
          </div>
        </li>
