...
<script type="text/javascript">
  function loadMore() {
    ...
    if (document.getElementById('view_more'))
      document.getElementById('view_more').style.display = "<?php echo ( $this->peopleyoumayknow->count() == $this->peopleyoumayknow->getCurrentPageNumber() || $this->count == 0 ? 'none' : '' ) ?>";
    ...
    en4.core.request.send(scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        scriptJquery('#sespymk_user_main').append(responseHTML);
        if(document.getElementById('view_more'))
        ...
        <div class="sespymk_list_item_inner">
          ...
          <div class="sespymk_list_item_btn rightT">
            <div class="sespymk_buttons">
              ...
              <?php } ?>
              <div>
                <a href="javascript:void(0);" class="sesbasic_button" onclick='removePeopleYouMayKnow(<?php echo $user->getIdentity(); ?>)'><?php echo $this->translate('Ignore');?></a>
              </div>
            </div>
          </div> 
        </div>
...
<script type="text/javascript">
  ...
  function removePeopleYouMayKnow(id) {
    ...
    scriptJquery.post(en4.core.baseUrl + "sespymk/index/ignore",{id:id},function(){})
  }
</script>
