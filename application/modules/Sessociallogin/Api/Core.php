...
class Sessociallogin_Api_Core extends Core_Api_Abstract {
  ...
  public function telegramEnable(){
    $settings['username'] = Engine_Api::_()->getApi('settings', 'core')->getSetting('sessociallogin.telegram.username', '');
    $settings['token'] = Engine_Api::_()->getApi('settings', 'core')->getSetting('sessociallogin.telegram.token', '');
    $settings['enable'] = Engine_Api::_()->getApi('settings', 'core')->getSetting('sessociallogin.telegram.enable', '0');
