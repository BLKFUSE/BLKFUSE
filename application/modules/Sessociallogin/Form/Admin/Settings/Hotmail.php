...
class Sessociallogin_Form_Admin_Settings_Hotmail extends Engine_Form {
    ...
    public function init() {
        ...
        'Here, you can integrate SocialEngine to Hotmail for allowing users to login into your website using their Hotmail accounts. To do so, create an Application through the ');

        $moreinfo = $this->getTranslator()->translate('<a href="%1$s" target="_blank">Hotmail Developers</a> page.<br />');
        ...
        $this->setTitle('Hotmail Integration')

                ->setDescription($description);



        $this->addElement('Text', 'sessociallogin_hotmailclientid', array(

            'label' => 'Hot mail Client Id',

            'description' => '',

            'value' => $settings->getSetting('sessociallogin.hotmailclientid', ''),

        ));

        $this->addElement('Text', 'sessociallogin_hotmailclientsecret', array(

            'label' => 'Hot mail Secret Id',

            'description' => '',

            'value' => $settings->getSetting('sessociallogin.hotmailclientsecret', ''),

        ));



        $this->addElement('Radio', "sessociallogin_hotmail_enable", array(
            ...
            'value' => $settings->getSetting('sessociallogin.hotmail.enable', 0),
         ...
         $this->addElement('Radio', "sessociallogin_hotmail_quick_signup", array(

            'label' => 'Enable Quick Signup Via Hotmail',

            'description' => 'Do you want to allow users to directly create their accounts on your website by enabling quick signup via Hotmail on your website? If you choose Yes, then users will not have to enter any details in the signup form.',
            ...
            'value' => $settings->getSetting('sessociallogin.hotmail.quick.signup', 0),
        ...
        if(engine_count($profileType)){
          ...
          $this->addElement('Select', "sessociallogin_hotmail_profile_type", array(
              ...
              'value' => $settings->getSetting('sessociallogin.hotmail.profile.type', 0),
        ...
        $this->addElement('Select', "sessociallogin_hotmail_member_level", array(
            ...
            'value' => $settings->getSetting('sessociallogin.hotmail.member.level', 4),
        ...
        $this->addElement('Select', "sessociallogin_hotmail_redirect_user", array(
            ...
            'value' => $settings->getSetting('sessociallogin.hotmail.redirect.user', 0),
