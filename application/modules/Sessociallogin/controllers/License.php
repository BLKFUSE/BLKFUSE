  ...
  if (1) {
    ...
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('sessociallogin.pluginactivated')) {
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_linkedin` (
        ...
        `linkedin_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_vk` (
        `user_id` int(11) UNSIGNED NOT NULL auto_increment,
        `vk_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `expires` bigint(20) UNSIGNED NOT NULL DEFAULT "0",
        PRIMARY KEY (`user_id`),
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_flickr` (
        ...
        `flickr_uid` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `expires` bigint(20) UNSIGNED NOT NULL DEFAULT "0",
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_instagram` (
        ...
        `user_id` INT(11) NOT NULL,
        `instagram_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `expires` bigint(20) UNSIGNED NOT NULL DEFAULT "0",
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_google` (
        ...
        `user_id` INT(11) NOT NULL,
        `google_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
        `expires` bigint(20) UNSIGNED NOT NULL DEFAULT "0",
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_yahoo` (
        ...
        `user_id` INT(11) NOT NULL,
        `yahoo_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_pinterest` (
        ...
        `user_id` INT(11) NOT NULL,
        `pinterest_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
      ...
      $db->query('CREATE TABLE IF NOT EXISTS `engine4_user_hotmail` (
        ...
        `user_id` INT(11) NOT NULL,
        `hotmail_uid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
        `access_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
