    ...
    if(value == 1) {
      ...
      if(params == 'form') {
        ...
        if('<?php echo $google_quick ?>' == 1) {
          ...
          document.getElementById('sessociallogin_google_profile_type-wrapper').style.display = 'none';

          document.getElementById('sessociallogin_google_member_level-wrapper').style.display = 'none';

          document.getElementById('sessociallogin_google_redirect_user-wrapper').style.display = 'none';
      ...
      document.getElementById('sessociallogin_google_quick_signup-wrapper').style.display = 'none';
