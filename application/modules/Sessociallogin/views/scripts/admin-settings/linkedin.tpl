    ...
    if(value == 1) {
      ...
      if(params == 'form') {
        ...
        if('<?php echo $linkedin_quick ?>' == 1) {
          ...
          document.getElementById('sessociallogin_linkedin_profile_type-wrapper').style.display = 'none';

          document.getElementById('sessociallogin_linkedin_member_level-wrapper').style.display = 'none';

          document.getElementById('sessociallogin_linkedin_redirect_user-wrapper').style.display = 'none';
      ...
      document.getElementById('sessociallogin_linkedin_quick_signup-wrapper').style.display = 'none';
