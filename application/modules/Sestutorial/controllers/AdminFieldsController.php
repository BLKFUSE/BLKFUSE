...
class Sestutorial_AdminFieldsController extends Fields_Controller_AdminAbstract {
  ...
  public function fieldEditAction() {
    ...
    $form->addElement('hidden', 'show', array('value' => 0));
    $form->removeElement('display');
    $linkCount = engine_count(Engine_Api::_()->fields()->getFieldsMaps($this->_fieldType)->getRowsMatching('child_id', $field->field_id));
    if ($linkCount >= 2) {
  ...
  public function typeCreateAction() {
    ...
    if ($form->getValue('duplicate') != 'null') {
      ...
      $field_map_array_count = engine_count($field_map_array);
      ...
      $map_count = engine_count($field_map_array);
