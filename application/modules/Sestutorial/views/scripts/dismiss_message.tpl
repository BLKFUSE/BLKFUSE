 ...
 */
?>
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenuItemName' => 'core_admin_main_plugins', 'childMenuItemName' => 'core_admin_main_plugins_sestutorial')); ?>
<h2 class="page_heading"><?php echo $this->translate("Multi - Use Tutorials Plugin") ?></h2>
