...
class Sesvideo_AdminCategoriesController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    //Get all categories
    $this->view->categories = Engine_Api::_()->getDbtable('categories', 'sesvideo')->getCategory(array('column_name' => '*', 'profile_type' => true, 'admin' => 1));
  }
  ...
  public function changeOrderAction() {
    if ($this->_getParam('id', false) || $this->_getParam('nextid', false)) {
      ...
      if ($checkTypeCategory)
        $currentOrder = Engine_Api::_()->getDbtable('categories', 'sesvideo')->order($categoryTypeId, $categoryType);
