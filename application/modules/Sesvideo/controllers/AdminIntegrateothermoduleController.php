  ...
  public function addmoduleAction() {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      try {
        ...
        $dbInsert->query('INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `enabled`, `custom`, `order`) VALUES ("sesvideo_main_browsevideo_'.$row->getIdentity().'", "sesvideo", "Browse Videos", "", \'{"route":"sesvideo_browsevideo_'.$row->getIdentity().'","action":"browse-videos", "resource_type":"'.$values['content_type'].'"}\', "'.$modulename.'_main", "", 1, 0, 999)');
  ...
  function createBrowseVideoPage($modulename, $id) {
    ...
    if (!$page_id) {
      ...
      $db->insert('engine4_core_pages', array(
          ...
          'displayname' => 'SNS - Advanced Videos - '.ucfirst($modulename).' Videos Browse Page',
