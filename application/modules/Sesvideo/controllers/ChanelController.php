    ...
    if (isset($values['video_ids']) && $values['video_ids'] != '' && isset($chanel->chanel_id)) {
      ...
      if ($runQuery) {
		...
		if($totalNewVideos >0){
			...
			'<table width="100%" bgcolor="#f0f0f0" class="admin_table_centered" valign="top" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td><table width="680" class="admin_table_centered">
  ...
  public function manageVideosAction() {
    ...
    if ($data || $is_chanel) {
      ...
      if ($is_chanel) {
        ...
        $this->view->countItem = engine_count($paginator);
      } else {
