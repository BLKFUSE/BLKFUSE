    ...
    <tr>
      ...
      <td>
      		<?php if($this->item->rating != 0) { ?>
               ...
               <span title="<?php echo $this->translate(array('%s rating', '%s ratings', round($this->item->rating,1)), $this->locale()->toNumber(round($this->item->rating,1)))?>"><i class="far fa-star"></i><?php echo round($this->item->rating,1).'/5';?></span>
                  <?php }else{ echo "-";} ?>
      </td>
    </tr>
   <?php } ?>
