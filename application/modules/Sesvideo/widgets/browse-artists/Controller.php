...
class Sesvideo_Widget_BrowseArtistsController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->all_params = $values = array('gridblock' => $gridblock, 'paginationType' => $paginationType, 'width' => $width, 'height' => $height, 'information' => $information, 'itemCount' => $itemCount, 'popularity' => $popularity, 'name' => $title, 'alphabet' => $values['alphabet']);
