...
<div class="sesvideo_view_labels">
  <?php if(engine_in_array('verified',$this->option) && $this->subject->getType() != 'video' && $this->subject->is_verified){ ?>
    <span class="sesvideo_label_verified"><?php echo $this->translate('Verified') ;?></span>
  <?php } ?>
  <?php if(engine_in_array('featured',$this->option) && $this->subject->is_featured){ ?>
    <span class="sesvideo_label_featured"><?php echo $this->translate('Featured') ;?></span>
  <?php } ?>
  <?php if(engine_in_array('sponsored',$this->option) && $this->subject->is_sponsored){ ?>
    <span class="sesvideo_label_sponsored"><?php echo $this->translate('Sponsored') ;?></span>
  <?php } ?>
  <?php if(engine_in_array('hot',$this->option) && $this->subject->is_hot){ ?>
    <span class="sesvideo_label_hot"><?php echo $this->translate('Hot') ;?></span>
  <?php } ?>
  <?php if(engine_in_array('offtheday',$this->option) && $this->subject->offtheday){ ?>
