...
<?php if( $this->form ): ?>
  <div class="sesbasic_browse_search_vertical">
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    AutocompleterRequestJSON('title_name', "<?php echo $this->url(array('module' => 'sesvideo', 'controller' => 'index', 'action' => 'search', 'actonType' => 'browse', 'sesvideo_commonsearch' => 'sesvideo_playlist'), 'default', true) ?>", function(selecteditem) {
