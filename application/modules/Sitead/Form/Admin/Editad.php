 ...
 */
class Sitead_Form_Admin_Editad extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Cancel', 'cancel', array(
        ...
        'link' => true,
        'prependText' => ' or ',
        'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'sitead', 'controller' => 'viewad', 'action' => 'index'), 'admin_default', true),
        'decorators' => array(
            'ViewHelper'
        )
    ));
