 ...
 */
class Sitead_Form_Admin_Module extends Engine_Form {
    ...
    public function init() {
        ...
        if (empty($module_id)) {
            $setModules = Engine_Api::_()->getDbTable('modules', 'sitead')->getModuleName();
            ...
            $module_obj = Engine_Api::_()->getItem('sitead_module', $module_id);
