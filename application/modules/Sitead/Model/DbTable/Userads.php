 ...
 */
class Sitead_Model_DbTable_Userads extends Engine_Db_Table {

  protected $_name = 'sitead_userads';
  protected $_rowClass = 'Sitead_Model_Userad';
  ...
  public function updateApproved($params=array()) {
    ...
    Engine_Api::_()->getApi('settings', 'core')->setSetting('sitead.update.approved', date('Y-m-d'));
  }
