...
?>
<h2>
  <?php echo $this->translate('Advertisements, Community Ads & Marketing Campaigns Plugin') ?>
</h2>
...
<h3><?php echo $this->translate('Manage Advertising Help Pages') ?></h3>
 <p><?php echo $this->translate("This page enables you to manage the advertising help pages of your site, and create an attractive overview of advertising on your site to get advertisers interested. You can offer guidelines to advertisers about different types of Ads, ad creation, management, statistics and other aspects. You can also offer tips to advertisers to create highly effective ads for your site.<br />
...
<?php
	...
	{
		echo '<ul class="form-notices" style="margin:0px;"><li style="float:left;">' . $this->translate('Successfully create') . ' ' . ucfirst($this->success_message) . ' ' . $this->translate('Sitead.') . '</li></ul>';
	}
?>
<p class="" style="display:block;">
	<?php
	// Show link for "Create Featured Content".
		echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'help-page-create'), $this->translate("Create a new Help Page"), array('class'=>'buttonlink cmad_icon_create'));
	?>
</p>
<br />
...
<form id='multidelete_form' method="post" action="<?php echo $this->url();?>" onSubmit="return multiDelete();" style="float:left;width:50%">
  <table class='admin_table'>
    ...
    <tbody>
      ...
      ?>
        <td class="admin_table_centered"> <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'status',  'id' => $item->infopage_id, 'status' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/enabled0.gif', '', array('title' => $this->translate('Enable Page'))), array('class' => 'smoothbox')) ?></td>
      <?php } else {
      ?>
        <td class=" admin_table_centered"> <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'status',  'id' => $item->infopage_id, 'status' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/enabled1.gif', '', array('title' => $this->translate('Disable Page'))), array('class' => 'smoothbox')) ?></td>
      <?php } ?>
          <td>
          <?php
						...
						echo $this->htmlLink(array('route' => 'sitead_help_and_learnmore', 'page_id' => $item->infopage_id), $this->translate("view"), array('target' => '_blank'));

						if ( empty($item->contect_team) ) {
							if( empty($item->page_default) ) {
								echo " | " . $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'help-page-create', 'page_id' => $item->infopage_id), $this->translate("edit"));
							}else {
								echo " | " . $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'default-help-msg', 'page_id' => $item->infopage_id), $this->translate("edit"), array('class' => 'smoothbox'));
							}
						}
						if ( !empty($item->delete) ) {
							echo ' | ';
							echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'help-page-delete', 'page_id' => $item->infopage_id), $this->translate("delete"), array('class' => 'smoothbox'));
						}
					?>
          </td>
        </tr>
