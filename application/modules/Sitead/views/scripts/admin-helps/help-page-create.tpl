...
<p>
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'helps', 'action' => 'help-and-learnmore'), $this->translate("Back to Manage Advertising Help Pages"), array('class'=>'cmad_icon_back buttonlink')) ?>
</p>
<br />
...
<p style="display:block;">
  ...
  ?>
	...
	// Show link for "Create Featured Content".
		echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'faqs', 'action' => 'faqcreate', 'page_id' => $this->page_id), $this->translate("Add an FAQ to this page"), array('class'=>'cmad_icon_create buttonlink'));
	?>
	<br style="clear:both;" />
</p><br />
        ...
        <tr>
          ...
          <?php
						if( empty($item->faq_default) ) {
							echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'faqs', 'action' => 'faqcreate', 'faq_id' => $item->faq_id, 'page_id' => $this->page_id), $this->translate("edit")) ;
							echo ' | ' . $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'faqs', 'action' => 'delete', 'faq_id' => $item->faq_id), $this->translate("delete"), array('class' => 'smoothbox'));
						}else {
							echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'faqs', 'action' => 'faq-default-msg', 'faq_id' => $item->faq_id), $this->translate("edit"), array('class' => 'smoothbox'));
						}
					?>
          </td>
        </tr>
