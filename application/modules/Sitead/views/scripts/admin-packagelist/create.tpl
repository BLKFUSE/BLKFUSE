...
<?php if (count($this->navigation)): ?>
  ...
  <div>
    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'packagelist', 'action' => 'index'), $this->translate('Back to Manage Ad Packages'), array('class' => 'cmad_icon_back buttonlink')) ?>
  </div>
  <br />
<?php endif; ?>
