  ...
  <div class="generic_layout_container">
	...
	<?php endif;?>
		...
		<div style="float:right;margin-top:3px;">
			<a href='<?php echo $this->url(array('module' => 'sitead', 'controller' => 'statistics', 'action' => 'export-report'), 'admin_default', true) ?>' class="buttonlink cmad_icon_back"><?php echo $this->translate('Generate Another Report') ?></a>
		</div>	
				      ...
				      switch($this->values['time_summary']) {
					    ...
					    <tr>
					      ...
					      <td style="text-align:left;" title="<?php echo $data->getOwner()->getTitle() ?>">
							<?php echo Engine_Api::_()->sitead()->truncation($data->getOwner()->getTitle(), 25); ?>
					      </td>
					      <td  style="text-align:left;" title="<?php echo ucfirst($data->name) ?>">
							<?php echo ucfirst(Engine_Api::_()->sitead()->truncation($data->name, 40)) ?>
					      </td>
					      <td style="text-align:left;">
							<?php echo $this->htmlLink(array('route' => 'sitead_userad', 'ad_id' => $data->userad_id),ucfirst($this->translate(Engine_Api::_()->sitead()->truncation($data->web_name, 30))),
						array( 'title' => ucfirst($data->web_name), 'target' => '_blank')) ?>
					      </td>
	      	...
	      	<thead>
					...
					<tbody>	
					    ...
					    <tr>
					      ...
					      <td style="text-align:left;" title="<?php echo $data->getOwner()->getTitle() ?>"><?php echo Engine_Api::_()->sitead()->truncation($data->getOwner()->getTitle(), 25); ?></td>
					      <td  style="text-align:left;" title="<?php echo ucfirst($data->name) ?>">
							<?php echo ucfirst(Engine_Api::_()->sitead()->truncation($data->name, 70)) ?>
					      </td>
					      <td title='<?php echo $this->translate("Views") ?>'>
					      	<?php 
								    if(!empty($data->views)) {
