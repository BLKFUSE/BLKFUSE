...
//  function formSubmit() {
//    var i;
//    var consignment_product_array = new Array();
...
//        if (inputs[i].checked) {
//          if (inputs[i].value) {
//            consignment_product_array[i] = inputs[i].value;
//          }
//        }
//      }
//    }
//    if (consignment_product_array.length == 0) {
//      return alert("<?php // echo $this->translate("You have not selected any customer entry. Please select at least one.") ?>");
//    }
//    var confirmation = confirm("<?php // echo $this->translate("Are you sure you want to delete the selected customer?") ?>");
//    if (confirmation != 1) {
//      return;
//    }
//
	 ...
	 <label>
	  <?php echo  $this->translate("Type") ?>	
       ...
       <select id="ad_type" name="ad_type"  >
          ...
          <option value="website" <?php if( $this->cmd_ad_type == 'website') echo $this->translate("selected");?> ><?php echo $this->translate("Website Ads") ?></option>
          <option value="content" <?php if( $this->cmd_ad_type == 'content') echo $this->translate("selected");?> ><?php echo $this->translate("Content Ads") ?></option>
          <option value="page" <?php if( $this->cmd_ad_type == 'page') echo $this->translate("selected");?> ><?php echo $this->translate("Page Ads") ?></option>
          <option value="boost" <?php if( $this->cmd_ad_type == 'boost') echo $this->translate("selected");?> ><?php echo $this->translate("Boost Post Ads") ?></option>
       </select>
      </div>
      ...
      <div>
        ...
        <select id="package" name="package" >
          ...
          <option value="<?php echo "$package->package_id" ?>" title ="<?php echo $this->translate(ucfirst($package->title)) ?>" <?php if( $this->package == $package->package_id) echo $this->translate("selected");?>  style="background:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitead/externals/images/<?php echo $package->type ?>.png) no-repeat left;padding-left:20px;"><?php echo Engine_Api::_()->sitead()->truncation($package->title,20) ?></option>
...
<form id='multidelete_form_table_rate' method="post" onsubmit="return formSubmit()">
    ...
    <thead>
      <tr>
          ...
          <th style='width: 1%;' class="<?php echo $class ?>"><a href="javascript:void(0);" onclick="javascript:changeOrder('userad_id', 'DESC');"><?php echo $this->translate('ID'); ?></a></th>
             <?php $class = ( $this->order == 'web_name' ? 'admin_table_ordering admin_table_direction_' . strtolower($this->order_direction) : '' ) ?>
          <th align="left" class="<?php echo $class ?>"><a href="javascript:void(0);"  title='<?php echo $this->translate('Ad Title') ?>' onclick="javascript:changeOrder('web_name', 'ASC');"><?php echo $this->translate('Title'); ?></a></th>
      ...
      <?php if( count($this->paginator) ): ?>
        <?php foreach( $this->paginator as $item ): ?>
         <tr>
					...
					<td style="white-space:normal;" title="<?php echo ucfirst($item->web_name) ?>">
						<?php echo $this->htmlLink(
							array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'viewad', 'action' => 'adpreview', 'ad_id' => $item->userad_id), $this->translate(ucfirst(Engine_Api::_()->sitead()->truncation($item->web_name, 14))),
							array('class' => 'smoothbox', 'title'=>$this->translate(ucfirst($item->web_name))))
						?>
					</td>
...
<?php  echo  $this->htmlImage($this->layout()->staticBaseUrl . "application/modules/Sitead/externals/images/$item->cmd_ad_type-icon-image.png"); ?>
					...
					<td title="<?php echo $item->getOwner()->getTitle() ?>"> 
						<?php echo $this->htmlLink($item->getOwner()->getHref(), Engine_Api::_()->sitead()->truncation($item->getOwner()->getTitle())) ?>
					</td>
            ...
            <?php endif; ?>
       			...
       			<!--Approved--> <?php if($item->approved == 1):?>
						<td align="center" class="admin_table_centered"> 
							    <?php
								    echo  $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/approved.gif');
							    ?>
						</td>
					<?php else: ?>
						<td align="center" class="admin_table_centered">
					    <?php 
						    echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unapproved.gif');
					    ?>
					  </td>
					<?php endif; ?>
		      ...
		      <!--Featured-->
			   	<?php if($item->featured == 1): ?>
						<td align="center" class="admin_table_centered">
				    <?php 				      
					echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/featured.gif');
				    ?>
					<?php else: ?>
						<td align="center" class="admin_table_centered"> 
						    <?php 
							echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unfeatured.gif');
						    ?>
						</td>
					<?php endif; ?>
   ...
   <?php if($item->sponsored == 1):?>
		<td align="center" class="admin_table_centered"> 
			    <?php 
				echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/sponsored.png'); 
			    ?>
			    <?php else: ?>
		<td align="center" class="admin_table_centered"> 
			    <?php  
				echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unsponsored.png');
			    ?>
		</td>
		<?php endif; ?>
    ...
    <?php if($item->approved == 1):?>
		<td align="center" class="admin_table_centered"> 
			    <?php
				    echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'approved', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/approved.gif', '', array('title'=> $this->translate('Make Dis-Approved'))))
			    ?>
		</td>
		<?php else: ?>
		<td align="center" class="admin_table_centered">
			    <?php 
				    echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'approved', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unapproved.gif', '', array('title'=> $this->translate('Make Approved'))))
			    ?>
	      </td>
		<?php endif; ?>
     ...
     <?php if($item->featured == 1): ?> 
		<td align="center" class="admin_table_centered">
			    <?php 
				    echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'featured', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/featured.gif', '', array('title'=> $this->translate('Make Un-featured')))); ?>
		<?php else: ?>
		<td align="center" class="admin_table_centered"> 
			    <?php 
				      echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'featured', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unfeatured.gif', '', array('title'=> $this->translate('Make Featured'))));
			    ?>
		</td>
		<?php endif; ?>
    ...
    <?php if($item->sponsored == 1):?>
		<td align="center" class="admin_table_centered"> 
			    <?php 
				    echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'sponsored', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/sponsored.png', '', array('title'=> $this->translate('Make Unsponsored')))); ?>
			    <?php else: ?>
		<td align="center" class="admin_table_centered"> 
			    <?php  
				    echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'sponsored', 'id' => $item->userad_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitead/externals/images/unsponsored.png', '', array('title'=> $this->translate('Make Sponsored')))); ?>
		</td>
		<?php endif; ?>
	...
	<?php endif; ?>
		...
		<td align="center" class="admin_table_centered" >
			...
			<?php
				echo $this->htmlLink(
				array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'packagelist', 'action' => 'packge-detail', 'id' => $item->package_id), $this->translate(ucfirst(Engine_Api::_()->sitead()->truncation($item->package_name, 14))), array('class' => 'smoothbox')
				) ?>
		</td>
...
<!--REMAINING-->
 ...
 <!--PAYMENT--> 
    ...
    <?php echo $this->htmlLink(
			array('route' => 'sitead_userad', 'ad_id' => $item->userad_id),
      ...
      <?php if($item->status!=4 && $item->declined !=1): ?>
                          ...
                          |
		<?php echo $this->htmlLink(
			array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'viewad', 'action' => 'editad', 'id' => $item->userad_id),
		...
		<?php  if(!empty($item->approved) && $item->status<=2) {
		      if($item->enable==1):
		    echo $this->htmlLink(
		      array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'viewad', 'action' => 'enabled', 'id' => $item->userad_id),
    ...
    <?php if($item->expiry_date !== '2250-01-01' && $item->limit_click != -1 && $item->limit_view != -1):
        ...
        echo $this->htmlLink(array('route' => 'default', 'module' => 'sitead', 'controller' => 'admin', 'action' => 'renew', 'id' => $item->userad_id), $this->translate('Renew'), array(
      ...
      <?php endif; ?>
		...
		<?php } ?>
		      <?php
		      echo $this->htmlLink(
		  array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'viewad', 'action' => 'deletead', 'id' => $item->userad_id),
  ...
  <br />
  <div class='buttons'>
	<button onclick="javascript:delectSelected();" type='submit' name="submit">
