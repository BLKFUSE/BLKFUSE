...
<script type="text/javascript">
	...
	var adModuleInfo = function( module_name )
	{
		if( $('is_adedit').value == 0 ){
			...
			$('adtable_name-label').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitead/externals/images/loader.gif" /></center>';
			...
			en4.core.request.send(new Request.JSON({
				url : en4.core.baseUrl + 'admin/sitead/widgets/admodulesinfo?module_name=' + module_name,
				data : {
					format : 'json'
				},
				onSuccess : function(responseJSON) {
					// Condition: Return the 'table name' acording to the module name, If selected module info is not available in 'sitead_module' table then it would be return 0.
	...
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'widgets', 'action' => 'admodule-manage'), $this->translate("Back to Manage Modules for Ads"), array('class'=>'cmad_icon_back buttonlink')) ?>
