...
?>
  ...
  <?php
	// Show link for "Create Featured Content".
		echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'widgets', 'action' => 'admodule-create'), $this->translate("Add New Module"), array('class'=>'buttonlink cmad_icon_create'));
	?>
	<br /><br />
...
<!--        <th class="left">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td >
          <?php
						echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'widgets', 'action' => 'admodule-create', 'module_id' => $item->module_id), $this->translate("edit")) ;
						if( empty($item->is_delete) ) {
							echo ' | ' . $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'widgets', 'action' => 'module-delete', 'module_id' => $item->module_id), $this->translate("delete"), array('class' => 'smoothbox'));
						}						
					?>
          </td>
