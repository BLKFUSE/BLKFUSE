...
<script type="text/javascript">
 var showAdminPages =function(page_id, widget_id, page_type){
    ...
    window.location.href= en4.core.baseUrl+'admin/sitead/widgets/widgetsettings/page_id/' + page_id + '/widget_id/' + widget_id;
  }
</script>
...
<?php endif; ?>
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitead', 'controller' => 'widgets', 'action' => 'manage'), $this->translate("Back to Manage Ad Blocks"), array('class'=>'cmad_icon_back buttonlink')) ?>
