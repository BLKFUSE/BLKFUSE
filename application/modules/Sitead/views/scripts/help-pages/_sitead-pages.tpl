 ...
 * @version    $Id: _site-pages.tpl  2011-02-16 9:40:21Z SocialEngineAddOns $
      ...
      if ( empty($this->display_faq) && empty($click_responce) && empty($this->page_id) ) {?>
		 ...
		 if ( !empty($this->contactTeam) ) { ?>
			<div class="cmad_halmc_form">
				<div>
					<p><?php echo $this->translate("Contact us for any assistance that you may require with advertising on this site.");?></p>
					<div class="form-wrapper">
						<div class="form-label">
							<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitead/externals/images/mobile.png" alt="" />
					...
					<div class="form-wrapper">
						<div class="form-label">
							<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitead/externals/images/mail.png" alt="" />
					...
					<div class="form-wrapper">
						<div class="form-label">
							<?php echo '<a href="'.$this->url(array('module' => 'sitead', 'controller' => 'display', 'action' => 'send-messages'), 'default', true).'" onclick="Smoothbox.open(this.href);return false;" class="cmad_icon_type_contact buttonlink">'. $this->translate("Contact us"). '</a>'; ?>
						</div>
					</div>
				</div>
			</div>	
