		...
		<ul class="cmad_package_list">
			<li style="width:650px;">	
	        	...
	        	<div class="cmad_hr_link">
	        		<a href="javascript:void(0);" onclick="createAD()"><?php echo $this->translate("SITEAD_PACKAGE_CREATE_BUTTON_".strtoupper($item['type'])); ?> &raquo;</a>
	        	</div>
        	<?php endif;?>
				...
				<div class="cmad_package_stat">
					<span>
						...
						<?php if(!$item->isFree()):?>
							<?php echo Engine_Api::_()->sitead()->getPriceWithCurrency($item['price']); ?>
		        <?php else:?>
  ...
  function createAD()
{
	...
	<?php $create_ad_url = $this->url(array('id' => $item['package_id']), 'sitead_create', true); ?>
