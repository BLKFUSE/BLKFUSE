...
<?php endif;?>
<form method="get" action="<?php if(!empty ($this->id)): echo $this->escape($this->url(array('ad_id'=>$this->id), 'sitead_userad', true)); else: echo $this->escape($this->url(array(), 'sitead_campaigns', true)); endif; ?>"
