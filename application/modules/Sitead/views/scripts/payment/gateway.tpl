...
<?php else: ?>
  ...
  <form method="get" action="<?php echo $this->escape($this->url(array(),'sitead_process_payment')) ?>"
    ...
    <div>
      <div>
        ...
        <p class="form-description">
          <?php echo $this->translate('You have created an ad that requires payment. You will be taken to a secure checkout area where you can pay for your ad.') ?>
        </p>
        ...
        function applyCreditcode() {
            ...
            en4.core.request.send(new Request.JSON({
              ...
              data: {
                ...
                package_type: 'sitead_package',
                package_id:<?php echo $this->userad->package_id ?>,
              },
              onRequest: function(){
