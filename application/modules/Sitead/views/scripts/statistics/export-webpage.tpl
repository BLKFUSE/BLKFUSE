	...
	<div class="layout_middle">
		<div class="cadcomp_vad_header">
			...
			<div class="cmad_hr_link">
				<a href='<?php echo $this->url(array(), 'sitead_reports', true) ?>'><i class="fa fa-angle-left" aria-hidden="true"></i><?php echo $this->translate(' Generate Another Report')?></a>
			</div>	
		</div>
				  ...
				  <?php foreach($this->rawdata as $data) : ?>
				    ...
				    <tr>
				      ...
				      <td  style="text-align:left;">
						<?php echo $this->htmlLink(array('route' => 'sitead_ads', 'adcampaign_id' => $data->adcampaign_id), ucfirst(Engine_Api::_()->sitead()->truncation($data->name, 50)), array('title' => ucfirst($data->name), 'target' => '_blank')) ?>
				      </td>
				      <td  style="text-align:left;">
						<?php echo $this->htmlLink(array('route' => 'sitead_userad', 'ad_id' => $data->userad_id),ucfirst($this->translate(Engine_Api::_()->sitead()->truncation($data->web_name, 50))),
      ...
      <table border="0">
			  ...
			  ?>
			    <tr>
			      <td><?php echo $date_value; ?></td>
			      <td  style="text-align:left;">
					<?php echo $this->htmlLink(array('route' => 'sitead_ads', 'adcampaign_id' => $data->adcampaign_id), ucfirst(Engine_Api::_()->sitead()->truncation($data->name, 100)), array('title' => ucfirst($data->name), 'target' => '_blank')) ?>
			      </td>
			      <td title='<?php echo $this->translate("Views") ?>'>
			      	<?php 
				      	if(!empty($data->views)) {
