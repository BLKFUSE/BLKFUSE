 ...
 */
class Sitead_Widget_CreateAdController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $this->view->viewer_object = $viewer_object = Engine_Api::_()->user()->getViewer();
    $checkCreate = Engine_Api::_()->authorization()->isAllowed('sitead', $viewer_object, 'create');
