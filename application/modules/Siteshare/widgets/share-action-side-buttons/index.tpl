...
<div class="siteshare_buttons_wp siteshare_action_floating_buttons siteshare_button_layout_border_count siteshare_action_buttons_<?php echo $this->params['alignment'] ?>"
...
<script type="text/javascript">
  $$('.siteshare_action_floating_buttons').inject(document.body);
  $$('.layout_siteshare_share_action_side_buttons').destroy();
