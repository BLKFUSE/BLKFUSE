...
(function (t) {
    ...
    function s() {
        (this._curInst = null),
            ...
            (this.regional[""] = {
                ...
                weekHeader: "Wk",
                dateFormat: dateFormatCalendar ? dateFormatCalendar : "mm/dd/yy",
                firstDay: 0,
                isRTL: !1,
    ...
    t.extend(s.prototype, {
        ...
        (t.fn.datepicker = function (e) {
            ...
            //change date format based on locale
            if(arguments && arguments[0].minDate) {
              var minDate = arguments[0].minDate;
              var minDateSplit = minDate.split('/');
              
              var minClenderDateSplit = dateFormatCalendar.split('/');
              
              var finalMinDate = [];
              if(minClenderDateSplit[0] == 'dd') {
                finalMinDate.push(minDateSplit[1]);
                finalMinDate.push(minDateSplit[0]);
              } else if(minClenderDateSplit[0] == 'mm') {
                finalMinDate.push(minDateSplit[0]);
                finalMinDate.push(minDateSplit[1]);
              }
              
              finalMinDate.push(minDateSplit[2]);
              arguments[0].minDate = finalMinDate.join('/');
            }
            if(arguments && arguments[0].dateFormat) {
              arguments[0].dateFormat = dateFormatCalendar;
            }
...
var scriptJqueryUIMin = jQuery.noConflict();
